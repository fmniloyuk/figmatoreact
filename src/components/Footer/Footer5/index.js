      ...
      <footer className={props.className}>
        <div className="mt-[3px] overflow-auto overflow-x-auto w-[100%]">
          <Column className="justify-start w-[100%]">
            <Column className="justify-start 2xl:ml-[101px] 3xl:ml-[122px] lg:ml-[72px] xl:ml-[90px] w-[93%]">
              ...
              <Row className="items-center justify-end 3xl:mt-[11px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] w-[100%]">
                ...
                <Stack
                  className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] lg:ml-[13px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[19%]"
                  style={{ backgroundImage: "url('images/img_adv_75.png')" }}
                >
                  <Img
            ...
            <Stack
              className="bg-cover bg-repeat 2xl:h-[1035px] 3xl:h-[1241px] lg:h-[735px] xl:h-[920px] lg:mr-[27px] xl:mr-[33px] 2xl:mr-[38px] 3xl:mr-[45px] lg:mt-[56px] xl:mt-[71px] 2xl:mt-[80px] 3xl:mt-[96px] lg:px-[10px] xl:px-[12px] 2xl:px-[14px] 3xl:px-[17px] w-[97%]"
