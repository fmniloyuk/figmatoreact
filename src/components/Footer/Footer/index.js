...
import { Stack, Column, Line, Row, Text, Img, Button } from "components";
  ...
  return (
    <>
      <footer className={props.className}>
        <Stack
          className="bg-cover bg-repeat 2xl:h-[1035px] 3xl:h-[1241px] lg:h-[735px] xl:h-[920px] lg:px-[10px] xl:px-[12px] 2xl:px-[14px] 3xl:px-[17px] w-[100%]"
        ...
        >
          <Stack className="absolute 2xl:h-[1001px] 3xl:h-[1201px] lg:h-[712px] xl:h-[890px] inset-[0] justify-center m-[auto] w-[96%]">
            ...
            <Column className="absolute bottom-[7%] items-center justify-start left-[0] w-[23%]">
              <Column className="justify-start w-[100%]">
                <Img src="images/img_logo.png" className="Logo1" alt="Logo" />
                <Text className="columnlogo1" variant="body9">
                  V-Verse, The First of it's Kind Worldwide, Mega New Eco-System
                  For the Veterinary Industry Global Community
                </Text>
