...
const FaisalFreelancingModuleSingleProjectPageDetailsPage = () => {
        ...
        <Column className="items-center justify-start w-[100%]">
          ...
          <Column className="font-poppins items-center justify-start lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] w-[100%]">
            <Row className="items-start w-[85%]">
              <Column className="bg-white_A700 border border-bluegray_102 border-solid justify-start lg:p-[10px] xl:p-[12px] 2xl:p-[14px] 3xl:p-[17px] rounded-radius15 w-[66%]">
                <Row className="items-center ml-[4px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] w-[76%]">
                  <Button
                ...
                <Column className="font-prompt items-center justify-start lg:ml-[3px] 2xl:ml-[4px] xl:ml-[4px] 3xl:ml-[5px] lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[99%]">
                  <Column className="justify-start w-[100%]">
                    <Column className="items-center justify-start pt-[3px] w-[100%]">
                      <Row className="items-start justify-between w-[97%]">
                        <Text className="rownameoftheve_one" variant="body7">
                          Project Order Details
                        </Text>
                        <Text
                          className="font-semibold text-black_900 uppercase w-[auto]"
                          variant="body10"
                        >
                          Total Price
                        </Text>
                      </Row>
                      <Row className="items-end justify-between mt-[2px] w-[100%]">
                        <Text
                    ...
                    <Column className="font-poppins items-center justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[35%]">
                  ...
                  <Column className="bg-white_A700 border border-black_900_20 border-solid font-poppins items-center justify-start lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] lg:p-[13px] xl:p-[16px] 2xl:p-[19px] 3xl:p-[22px] rounded-radius15 w-[100%]">
                    <Row className="items-start justify-between w-[99%]">
                      <Row className="items-start justify-between w-[29%]">
                        ...
                        <Text className="mt-[4px] rowuser" variant="body9">
                          14-Dec-2022
                        </Text>
                      </Row>
                    ...
                    <Column className="items-center justify-start lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                      <Column className="border border-black_900_20 border-solid items-center justify-start 3xl:pb-[11px] lg:pb-[6px] xl:pb-[8px] 2xl:pb-[9px] w-[99%]">
                      ...
                      <Column className="border border-black_900_20 border-solid items-center justify-end lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] lg:pt-[10px] xl:pt-[12px] 2xl:pt-[14px] 3xl:pt-[17px] w-[100%]">
                        ...
                        <Row className="items-center justify-between lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] py-[3px] w-[99%]">
                        ...
                        <Row className="items-start justify-between lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] pb-[3px] w-[99%]">
                ...
                <Text
                  className="lg:mb-[558px] xl:mb-[698px] 2xl:mb-[785px] 3xl:mb-[942px] lg:ml-[48px] xl:ml-[61px] 2xl:ml-[68px] 3xl:ml-[82px] lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] rowuser"
                  variant="body10"
                >
                  <span className="text-bluegray_400 font-poppins lg:text-[9px] xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px]">
...
export default FaisalFreelancingModuleSingleProjectPageDetailsPage;
