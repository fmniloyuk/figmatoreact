...
const IMARNFrontendWebsiteAIOProfileProfileSectionCoverLetterPage = () => {
  const navigate = useNavigate();

  function handleNavigate6() {
    navigate("/imarnfrontendwebsiteaioprofilegeneralsection");
  }
      ...
      <Column className="bg-white_A700 font-poppins items-center justify-start mx-[auto] overflow-auto pt-[2px] w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_27X173.svg"
        ...
        <Column className="justify-start lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[85%]">
          <Row className="items-center ml-[1px] w-[63%]">
            <Button
              className="common-pointer capitalize font-medium lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-bluegray_400 text-center w-[15%]"
            ...
            <Column className="items-center justify-start w-[100%]">
              ...
              <Row className="items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-start lg:p-[12px] xl:p-[15px] 2xl:p-[17px] 3xl:p-[20px] rounded-radius15 w-[69%]">
                  <Column className="items-center justify-start lg:mb-[12px] xl:mb-[16px] 2xl:mb-[18px] 3xl:mb-[21px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[9px] w-[100%]">
                    ...
                    <Text
                      className="capitalize font-normal leading-[140.00%] lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] not-italic text-bluegray_400 w-[97%]"
                      variant="body10"
                    >
                      ...
                      fringilla amet sapien. Eget nunc posuere sit aliquet nisl.
                      Faucibus at consequat tristique libero rhoncus tempor sem.
                      Lectus urna, pellentesque velit, amet, eget sed. Ac
                      maecenas venenatis nibh ut. Gravida natoque vel massa
                      vitae magna eu purus vitae.
                      <br />
                      <br />
                      Cras risus, faucibus in sit vulputate sagittis,
                      ullamcorper egestas at. Enim tortor nulla neque, nisl,
                      dictumst suspendisse felis. Vulputate nisi, cursus turpis
                      sagittis integer pellentesque eget eu, risus. Vitae
                      feugiat nibh maecenas nisl, felis, ullamcorper. Quam
                      tellus feugiat tellus enim amet, amet orci turpis.
                      ...
                      tellus. Id tellus, nec, pellentesque non turpis eleifend.
                      <br />
                      <br />
                      Lacus, adipiscing gravida nisl id congue bibendum enim. Ut
                      molestie nunc habitasse mattis. Justo, augue nibh aliquam
                      tempus mi suspendisse senectus cras. Quam tempor,
                      curabitur laoreet tortor sem mattis. Tempus, morbi sed
                      porttitor adipiscing. Nunc at leo pellentesque non laoreet
                      leo massa eget. Imperdiet sed nulla in amet semper
                      imperdiet velit quis vulputate. Justo lectus pellentesque
                      morbi dictumst. Viverra libero cras pellentesque ipsum.
                      Proin et nunc felis pretium odio lacus, faucibus. Posuere
                      et nulla id interdum eros, fusce risus. Leo eget nunc
                      integer purus integer convallis enim suspendisse porta.
                      Nunc libero faucibus non sem aliquet ut.
                      <br />
                      <br />
                      Pellentesque morbi cras enim sapien, pretium faucibus amet
                      non. Volutpat laoreet tristique vulputate urna, ornare
                      libero ut. Egestas elementum feugiat hendrerit amet,
                      tortor. Tempus, duis tortor amet bibendum aliquet ultrices
                      id molestie.{" "}
                    </Text>
                  </Column>
                </Column>
        ...
        <Column className="items-end lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] 2xl:pl-[104px] 3xl:pl-[125px] lg:pl-[74px] xl:pl-[93px] w-[100%]">
          <Column className="justify-start w-[100%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_20.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileProfileSectionCoverLetterPage;
