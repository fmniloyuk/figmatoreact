...
const IMARNFrontendWebsiteAIOProfileSocialSectionGalleryVideosPage = () => {
  const navigate = useNavigate();

  function handleNavigate32() {
    navigate("/imarnfrontendwebsiteaioprofilesocialsectiongalleryphotos");
  }
  ...
  return (
    <>
      <Column className="bg-white_A700 font-poppins justify-start mx-[auto] overflow-auto pt-[2px] w-[100%]">
        <Column className="items-center lg:pr-[29px] xl:pr-[36px] 2xl:pr-[40px] 3xl:pr-[49px] w-[100%]">
                ...
                <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                  <Row className="items-center justify-between w-[99%]">
                    <Column className="items-center w-[23%]">
                      ...
                      <Img
                        src="images/img_emailphonepay_9.svg"
          ...
          <Column className="items-center justify-start lg:mt-[27px] xl:mt-[33px] 2xl:mt-[38px] 3xl:mt-[45px] 3xl:pb-[1008px] lg:pb-[597px] xl:pb-[747px] 2xl:pb-[840px] w-[85%]">
            <Column className="items-center justify-start w-[100%]">
              ...
              <Row className="items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-end 3xl:py-[11px] lg:py-[6px] xl:py-[8px] 2xl:py-[9px] rounded-radius15 w-[68%]">
                  <Column className="justify-start 3xl:mt-[11px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] w-[100%]">
                    <Row className="items-start lg:ml-[13px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] pb-[3px] w-[26%]">
                      <Column
                        className="common-pointer items-center justify-start w-[18%]"
                      ...
                      >
                        ...
                        >
                          <Img
                            src="images/img_bookmark_38X38.svg"
                      ...
                      <Column className="justify-start lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] w-[18%]">
                        <Button
                    ...
                    <Column className="items-center justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[100%]">
                      <Line className="bg-black_900_14 h-[1px] w-[100%]" />
                      <Grid className="lg:gap-[20px] xl:gap-[25px] 2xl:gap-[28px] 3xl:gap-[34px] grid grid-cols-3 lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[95%]">
                        <Column className="justify-start w-[100%]">
                          <Column className="bg-black_900 items-center justify-start rounded-radius15 w-[100%]">
                            <Column
                              className="bg-cover bg-repeat items-center justify-start lg:p-[50px] xl:p-[63px] 2xl:p-[71px] 3xl:p-[85px] rounded-radius15 w-[100%]"
                              style={{
                                backgroundImage:
                                  "url('images/img_group460.png')",
                              }}
                            >
                              <Button
                                ...
                                size="xlIcn"
                                variant="icbOutlineBlack900331_2"
                              >
                                <Img
                          ...
                          <Text className="VideoName" variant="body10">
                            {"<Video Name>"}
                          </Text>
                        ...
                        <Column className="justify-start w-[100%]">
                          <Column className="bg-black_900 items-center justify-start rounded-radius15 w-[100%]">
                            <Column
                              ...
                              style={{
                                backgroundImage:
                                  "url('images/img_rectangle98.png')",
                              }}
                            >
                              <Button
                                className="flex lg:h-[34px] xl:h-[43px] 2xl:h-[48px] 3xl:h-[58px] items-center justify-center rounded-radius50 lg:w-[33px] xl:w-[42px] 2xl:w-[47px] 3xl:w-[57px]"
                        ...
                        <Column className="justify-start w-[100%]">
                          <Column className="bg-black_900 items-center justify-start rounded-radius15 w-[100%]">
                            <Column
                              ...
                              style={{
                                backgroundImage:
                                  "url('images/img_rectangle100.png')",
                              }}
                            >
                              <Button
                                className="flex lg:h-[34px] xl:h-[43px] 2xl:h-[48px] 3xl:h-[58px] items-center justify-center rounded-radius50 lg:w-[33px] xl:w-[42px] 2xl:w-[47px] 3xl:w-[57px]"
                        ...
                        <Column className="justify-start w-[100%]">
                          <Column className="bg-black_900 items-center justify-start rounded-radius15 w-[100%]">
                            <Column
                              ...
                              style={{
                                backgroundImage:
                                  "url('images/img_rectangle96.png')",
                              }}
                            >
                              <Button
                                className="flex lg:h-[34px] xl:h-[43px] 2xl:h-[48px] 3xl:h-[58px] items-center justify-center rounded-radius50 lg:w-[33px] xl:w-[42px] 2xl:w-[47px] 3xl:w-[57px]"
                        ...
                        <Column className="justify-start w-[100%]">
                          <Column className="bg-black_900 items-center justify-start rounded-radius15 w-[100%]">
                            <Column
                              ...
                              style={{
                                backgroundImage:
                                  "url('images/img_adv_250X300.png')",
                              }}
                            >
                              <Button
                                className="flex lg:h-[34px] xl:h-[43px] 2xl:h-[48px] 3xl:h-[58px] items-center justify-center rounded-radius50 lg:w-[33px] xl:w-[42px] 2xl:w-[47px] 3xl:w-[57px]"
                      ...
                      <Stack className="lg:h-[29px] xl:h-[36px] 2xl:h-[41px] 3xl:h-[49px] lg:mt-[23px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[40px] w-[100%]">
        ...
        <Column className="items-end xl:mt-[100px] 2xl:mt-[113px] 3xl:mt-[136px] lg:mt-[80px] 2xl:pl-[104px] 3xl:pl-[125px] lg:pl-[74px] xl:pl-[93px] w-[100%]">
          <Column className="justify-start w-[100%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_29.png')" }}
              >
                <Img
        ...
        <Column className="items-center lg:mt-[56px] xl:mt-[71px] 2xl:mt-[80px] 3xl:mt-[96px] lg:pr-[29px] xl:pr-[36px] 2xl:pr-[40px] 3xl:pr-[49px] w-[100%]">
...
export default IMARNFrontendWebsiteAIOProfileSocialSectionGalleryVideosPage;
