...
import { Column, Stack, Row, Img, Text, Line, List, Button } from "components";
import Footer from "components/Footer/Footer";
import { useNavigate } from "react-router-dom";

const IMARNFrontendWebsiteAIOProfileGeneralSectionPage = () => {
  ...
  function handleNavigate12() {
    navigate("/imarnfrontendwebsiteaioprofileprofilesectioncoverletter");
  }
  function handleNavigate194() {
    window.location.href = "www.drjohnk.com";
  }
    ...
    <>
      <Column className="bg-white_A700 font-poppins items-center justify-start mx-[auto] overflow-auto pt-[2px] w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay.svg"
                    ...
                    <Row className="items-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[100%]">
                      ...
                      <Column className="justify-start lg:ml-[17px] xl:ml-[22px] 2xl:ml-[24px] 3xl:ml-[29px] lg:mt-[16px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] w-[18%]">
                        <Column className="justify-start pb-[2px] w-[36%]">
                          ...
                          <Row className="items-start mt-[1px] w-[93%]">
                            <Img
                              src="images/img_gender.svg"
                              className="gender_One"
                              alt="gender One"
                            />
                        ...
                        <Row className="items-start lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] w-[36%]">
                          <Img
                            src="images/img_globe.svg"
                            className="globe"
                            alt="globe"
                          />
                          <Text className="mt-[2px] likes" variant="body10">
                            Egypt
                          </Text>
                        </Row>
                        <Row className="items-start justify-evenly lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] w-[100%]">
                          <Img
                        ...
                        <Row className="items-start lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] w-[40%]">
                          <Img
                            src="images/img_clock_16X16.svg"
                            className="gender_One"
                            alt="clock"
                          />
                          <Text className="ml-[4px] date" variant="body10">
                            1:00PM
                          </Text>
                        </Row>
                        <Row className="items-center 3xl:mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] w-[62%]">
                          <Img
                        ...
                        <Column className="items-center justify-start lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] py-[1px] w-[86%]">
                ...
                <Column className="items-center justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[100%]">
                  <Column className="items-center justify-start w-[99%]">
                    ...
                    <Row className="items-center justify-center lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[67%]">
                      ...
                      >
                        <div className="common-pointer bg-transparent capitalize font-normal not-italic xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px] lg:text-[9px]">
                          Endorse
                        </div>
                      </Button>
                      <Button
            ...
            <Row className="bg-white_A700 border border-black_900_19 border-solid items-center lg:p-[13px] xl:p-[16px] 2xl:p-[19px] 3xl:p-[22px] w-[100%]">
              <Row className="items-start mb-[1px] 3xl:ml-[11px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] w-[99%]">
                <Img
                  ...
                  alt="Group"
                />
                <Row className="items-center justify-center 3xl:ml-[1160px] lg:ml-[687px] xl:ml-[859px] 2xl:ml-[967px] mt-[3px] w-[22%]">
                  <Button
                    className="flex items-center justify-center text-center w-[48%]"
                    leftIcon={
                      <Img
                    ...
                    variant="OutlineBlue700"
                  >
                    <div className="bg-transparent capitalize font-semibold lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px]">
                      Hey Roy!
                    </div>
                  </Button>
                  <Column className="items-center lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] w-[31%]">
                    <Button
                      className="bg-gradient  flex items-center justify-center text-center w-[100%]"
                      leftIcon={
                        <Img
                    ...
                    >
                      <div className="bg-transparent capitalize font-semibold lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-white_A700">
                        Add
                      </div>
                    </Button>
                  </Column>
                  <Stack className="lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] VendorPlatinum">
                    <Img
                    ...
                    />
                    <Column className="absolute bg-gray_102 border border-blue_700 border-solid lg:h-[28px] xl:h-[34px] 2xl:h-[39px] 3xl:h-[46px] items-center justify-start px-[2px] rounded-radius50 w-[100%]">
                      <Img
                        src="images/img_image1_35X35.png"
                        className="lg:h-[24px] xl:h-[30px] 2xl:h-[34px] 3xl:h-[41px] mt-[3px] rounded-radius50 lg:w-[23px] xl:w-[29px] 2xl:w-[33px] 3xl:w-[40px]"
                        alt="imageOne"
                      />
                    </Column>
                  </Stack>
                ...
                <Img
                  ...
                  className="lg:h-[21px] xl:h-[26px] 2xl:h-[29px] 3xl:h-[35px] lg:ml-[16px] xl:ml-[21px] 2xl:ml-[23px] 3xl:ml-[28px] 3xl:mt-[11px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] lg:w-[20px] xl:w-[25px] 2xl:w-[28px] 3xl:w-[34px]"
                  alt="menu"
                />
              </Row>
            </Row>
        ...
        <Column className="bg-white_A700 border border-black_900_0c border-solid justify-center lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] xl:p-[11px] 2xl:p-[13px] 3xl:p-[16px] lg:p-[9px] rounded-radius10 shadow-bs11 w-[85%]">
          <Text className="profilesprogr" variant="body9">
          ...
          <Column className="bg-bluegray_50 justify-start lg:mb-[4px] 2xl:mb-[5px] xl:mb-[5px] 3xl:mb-[6px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[9px] rounded-radius8 w-[100%]">
            <Text className="progressbar" variant="body13">
              70%
            </Text>
          </Column>
        </Column>
        <Column className="justify-start lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[85%]">
          <Column className="items-center justify-start ml-[1px] w-[63%]">
            <Row className="items-center justify-evenly w-[100%]">
              <Button
                className="capitalize font-medium lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-center w-[15%]"
              ...
              <Button
                className="common-pointer capitalize font-medium lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-bluegray_400 text-center w-[16%]"
              ...
              <Button
                className="capitalize font-medium lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-bluegray_400 text-center w-[13%]"
                shape="CircleBorder12"
                size="lg"
                variant="FillWhiteA700"
              >
              ...
              <Button
                className="capitalize font-medium lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-bluegray_400 text-center w-[20%]"
                shape="CircleBorder12"
                size="lg"
                variant="FillWhiteA700"
              >
              ...
              <Button
                className="capitalize font-medium lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-bluegray_400 text-center w-[14%]"
                shape="CircleBorder12"
                size="lg"
                variant="FillWhiteA700"
              >
              ...
              <Button
                className="capitalize font-medium lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-bluegray_400 text-center w-[21%]"
                shape="CircleBorder12"
                size="lg"
                variant="FillWhiteA700"
              >
          ...
          <Column className="items-center justify-start lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[100%]">
            <Column className="items-center justify-start w-[100%]">
              <Line className="bg-black_900_14 h-[1px] w-[100%]" />
              <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] rounded-radius15 shadow-bs11 w-[100%]">
                <div className="overflow-x-auto w-[99%]">
                  <Row className="items-center justify-between 3xl:pl-[11px] lg:pl-[6px] xl:pl-[8px] 2xl:pl-[9px] 3xl:py-[11px] lg:py-[6px] xl:py-[8px] 2xl:py-[9px] w-[100%]">
                    <Column className="items-center 3xl:ml-[11px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] w-[42%]">
                      <Column className="items-end justify-start w-[100%]">
                        <Row className="items-start w-[100%]">
                          <Img
                            ...
                            alt="One"
                          />
                          <Text className="rowone1" variant="body8">
                            Do what you can, with what you have, where you are.
                          </Text>
                        </Row>
                        <Row className="items-center justify-end ml-[auto] mt-[3px] w-[32%]">
                          <Text className="rowtheodoreroose" variant="body12">
                            ―Theodore Roosevelt.
                          </Text>
                          <Img
                            src="images/img_call_16X20.svg"
                            className="lg:h-[11px] xl:h-[14px] 2xl:h-[16px] 3xl:h-[19px] 3xl:ml-[11px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] w-[12%]"
                            alt="call"
                          />
                        </Row>
                      </Column>
                    </Column>
                    <Column className="items-center mt-[1px] w-[38%]">
                      <Column className="items-end justify-start w-[100%]">
                        <Row className="items-start w-[100%]">
                          <Img
                            src="images/img_.svg"
                        ...
                        <Row className="items-start justify-end ml-[auto] mt-[1px] w-[25%]">
                          <Text className="rowgeorgeeliot" variant="body12">
                            ―George Eliot
                          </Text>
                          <Img
                            src="images/img_call_16X20.svg"
                            className="lg:h-[11px] xl:h-[14px] 2xl:h-[16px] 3xl:h-[19px] 3xl:ml-[11px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] w-[17%]"
                            alt="call One"
                          />
                        </Row>
                      </Column>
                    </Column>
                    <Row className="items-start mt-[1px] w-[38%]">
                      <Img
                        src="images/img_.svg"
                        className="One18"
                        alt="Three"
                      />
                      <Text
                        className="lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] rowone1"
                        variant="body8"
                      >
                        If you can dream it, you can do it.
                      </Text>
                      <Text
                        className="lg:ml-[122px] xl:ml-[153px] 2xl:ml-[172px] 3xl:ml-[206px] lg:mt-[17px] xl:mt-[22px] 2xl:mt-[24px] 3xl:mt-[29px] rowtheodoreroose"
                        variant="body12"
                      >
                        Walt Disney
                      </Text>
                      <Img
                        src="images/img_call_1.png"
                        className="3xl:ml-[11px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] lg:mt-[17px] xl:mt-[22px] 2xl:mt-[24px] 3xl:mt-[29px] One18"
                        alt="call Two"
                      />
                    </Row>
                  </Row>
              ...
              <Row className="font-prompt items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                <Column className="items-center justify-start w-[69%]">
                  <Column className="items-center justify-start w-[100%]">
                    <Column className="bg-white_A700 border border-black_900_0c border-solid justify-center lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius15 w-[100%]">
                      <Text
                        className="capitalize lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] text-blue_700 w-[auto]"
                        variant="body2"
                      >
                        My General Info
                      </Text>
                      <Row className="font-poppins items-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[35%]">
                        <Text className="MyPrefix" variant="body10">
                          My Prefix:
                        </Text>
                        <Text
                          className="capitalize font-medium lg:ml-[138px] xl:ml-[173px] 2xl:ml-[195px] 3xl:ml-[234px] my-[1px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          Dr.
                        </Text>
                      </Row>
                      <Row className="font-poppins items-center xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[56%]">
                        <Text className="MyPrefix" variant="body10">
                          My Official Full Name:
                        </Text>
                        <Text
                          className="capitalize font-medium 2xl:ml-[108px] 3xl:ml-[130px] lg:ml-[77px] xl:ml-[96px] my-[1px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          John Charles Marc Kennedy
                        </Text>
                      </Row>
                      <Row className="font-poppins items-start xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[42%]">
                        <Text className="MyPrefix" variant="body10">
                          My Birthday:
                        </Text>
                        <Text
                          className="capitalize font-medium lg:ml-[123px] xl:ml-[154px] 2xl:ml-[173px] 3xl:ml-[208px] my-[1px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          15-09-1990
                        </Text>
                      </Row>
                      <Row className="font-poppins items-start xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[40%]">
                        <Text className="MyPrefix" variant="body10">
                          My Age:
                        </Text>
                        <Text
                          className="capitalize font-medium mb-[1px] lg:ml-[146px] xl:ml-[183px] 2xl:ml-[206px] 3xl:ml-[248px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          32 Years
                        </Text>
                      </Row>
                      <Row className="font-poppins items-center xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[57%]">
                        <Text className="mb-[1px] MyPrefix" variant="body10">
                          My Hobbies:
                        </Text>
                        <Text
                          className="capitalize font-medium lg:ml-[125px] xl:ml-[156px] 2xl:ml-[176px] 3xl:ml-[211px] mt-[1px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          Swimming, Reading, Football
                        </Text>
                      </Row>
                      <Row className="font-poppins items-start xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[36%]">
                        <Text className="MyPrefix" variant="body10">
                          My Horoscope:
                        </Text>
                        <Text
                          className="capitalize font-medium mb-[1px] lg:ml-[113px] xl:ml-[141px] 2xl:ml-[159px] 3xl:ml-[190px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          Leo
                        </Text>
                      </Row>
                      <Line className="bg-black_900_20 h-[1px] lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[59%]" />
                      <Row className="font-poppins items-center lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[41%]">
                        <Text className="MyPrefix" variant="body10">
                          My Employment Status:
                        </Text>
                        <Text
                          className="capitalize font-medium mb-[1px] 3xl:ml-[112px] lg:ml-[66px] xl:ml-[83px] 2xl:ml-[93px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          Employed
                        </Text>
                      </Row>
                      <Row className="font-poppins items-start xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[49%]">
                        <Text className="MyPrefix" variant="body10">
                          My Current Title:
                        </Text>
                        <Text
                          className="capitalize font-medium lg:ml-[102px] xl:ml-[128px] 2xl:ml-[144px] 3xl:ml-[173px] my-[1px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          GCC Sales Director
                        </Text>
                      ...
                      <Row className="font-poppins items-start xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[44%]">
                        ...
                        <Text
                          className="capitalize font-medium mb-[1px] 2xl:ml-[108px] 3xl:ml-[130px] lg:ml-[77px] xl:ml-[96px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          ICON Pharma
                        </Text>
                      ...
                      <Row className="font-poppins items-start xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[40%]">
                        ...
                        <Text
                          className="capitalize font-medium xl:ml-[111px] 2xl:ml-[125px] 3xl:ml-[150px] lg:ml-[89px] my-[1px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          10 Years
                        </Text>
                      </Row>
                      <Row className="font-poppins items-center xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[54%]">
                        <Text className="MyPrefix" variant="body10">
                          My Languages
                        </Text>
                        <Text
                          className="capitalize font-medium mb-[1px] lg:ml-[113px] xl:ml-[142px] 2xl:ml-[160px] 3xl:ml-[192px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          Arabic - English - French
                        </Text>
                      </Row>
                      <Row className="font-poppins items-center xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[44%]">
                        <Text className="MyPrefix" variant="body10">
                          My Driving License{" "}
                        </Text>
                        <Text
                          className="capitalize font-medium xl:ml-[116px] 2xl:ml-[130px] 3xl:ml-[156px] lg:ml-[92px] my-[1px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          Valid - Egypt
                        </Text>
                      </Row>
                      <Row className="font-poppins items-start 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[9px] w-[39%]">
                        <Text className="mt-[2px] MyPrefix" variant="body10">
                          My Services Rate per Hour:
                        </Text>
                        <Text
                          className="capitalize font-medium mb-[1px] lg:ml-[58px] xl:ml-[73px] 2xl:ml-[82px] 3xl:ml-[99px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          $100/hr
                        </Text>
                      </Row>
                      <Row className="font-poppins items-start xl:mt-[11px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] w-[36%]">
                        <Text className="MyPrefix" variant="body10">
                          My Expected Salary:
                        </Text>
                        <Text
                          className="capitalize font-medium mb-[1px] xl:ml-[106px] 2xl:ml-[120px] 3xl:ml-[144px] lg:ml-[85px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          $3K
                        </Text>
                      </Row>
                      <Row className="font-poppins items-start lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] w-[39%]">
                        <Text className="MyPrefix" variant="body10">
                          My Social Status:
                        </Text>
                        <Text
                          className="capitalize font-medium lg:ml-[100px] xl:ml-[125px] 2xl:ml-[141px] 3xl:ml-[169px] my-[1px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          Married
                        </Text>
                      </Row>
                      <Row className="font-poppins items-center xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[42%]">
                        <Text className="MyPrefix" variant="body10">
                          My Military Status:
                        </Text>
                        <Text
                          className="capitalize font-medium xl:ml-[115px] 2xl:ml-[129px] 3xl:ml-[155px] lg:ml-[92px] my-[1px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          Completed
                        </Text>
                      ...
                      <Line className="bg-black_900_20 h-[1px] lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[59%]" />
                      <Row className="font-poppins items-center lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[53%]">
                        <Text className="mb-[1px] MyPrefix" variant="body10">
                          My Email:
                        </Text>
                        <Text
                          className="font-medium lg:ml-[138px] xl:ml-[172px] 2xl:ml-[194px] 3xl:ml-[233px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          dr.john1990@gmail.com
                        </Text>
                      </Row>
                      <Row className="font-poppins items-start xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[47%]">
                        <Text className="MyPrefix" variant="body10">
                          My Phone:
                        </Text>
                        <Text
                          className="font-medium mb-[1px] lg:ml-[134px] xl:ml-[168px] 2xl:ml-[189px] 3xl:ml-[227px] text-gray_800 w-[auto]"
                          variant="body10"
                        >
                          +971-527956665
                        </Text>
                      </Row>
                      <Row className="font-poppins items-center xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[48%]">
                        <Text className="MyPrefix" variant="body10">
                          My Website:
                        </Text>
                        <Text
                          className="common-pointer font-medium lg:ml-[125px] xl:ml-[156px] 2xl:ml-[176px] 3xl:ml-[211px] my-[1px] text-gray_800 w-[auto]"
                          variant="body10"
                      ...
                      <Row className="font-poppins items-center 2xl:mb-[10px] 3xl:mb-[12px] lg:mb-[7px] xl:mb-[9px] xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[58%]">
                        <Text className="MyPrefix" variant="body10">
                          My Social Media Accounts:
                        </Text>
                        <Img
                          src="images/img_socialicons.svg"
                          className="lg:h-[11px] xl:h-[14px] 2xl:h-[16px] 3xl:h-[19px] lg:ml-[52px] xl:ml-[65px] 2xl:ml-[73px] 3xl:ml-[88px] w-[43%]"
                          alt="socialicons"
                        />
                      </Row>
                    </Column>
                    <Column className="bg-white_A700 border border-black_900_0c border-solid justify-center lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] lg:p-[12px] xl:p-[15px] 2xl:p-[17px] 3xl:p-[20px] rounded-radius15 w-[100%]">
                      <Text
                        className="ml-[1px] lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] rowcoverletter_one"
                        variant="body2"
                      >
                        My Profile Message
                      </Text>
                      <Text
                        className="capitalize font-normal font-poppins leading-[140.00%] lg:my-[12px] xl:my-[15px] 2xl:my-[17px] 3xl:my-[20px] not-italic text-bluegray_400 w-[97%]"
                        variant="body10"
                      >
                        Mauris tortor elit vel ut. Enim mattis eget in augue vel
                        eget. Tempus sed dictum donec ornare curabitur mauris
                        facilisis. Quisque tortor, arcu adipiscing est elementum
                        donec in. <br />
                        <br />
                        In bibendum elit maecenas aenean congue.
                        <br />
                        <br />
                        Tincidunt vitae dignissim nulla sollicitudin porttitor
                        fringilla amet sapien. Eget nunc posuere sit aliquet
                        nisl. Faucibus at consequat tristique libero rhoncus
                        tempor sem. Lectus urna, pellentesque velit, amet, eget
                        sed. Ac maecenas venenatis nibh ut. Gravida natoque vel
                        massa vitae magna eu purus vitae.
                        <br />
                        <br />
                        Cras risus, faucibus in sit vulputate sagittis,
                        ullamcorper egestas at. Enim tortor nulla neque, nisl,
                        dictumst suspendisse felis. Vulputate nisi, cursus
                        turpis sagittis integer pellentesque eget eu, risus.
                        Vitae feugiat nibh maecenas nisl, felis, ullamcorper.
                        Quam tellus feugiat tellus enim amet, amet orci turpis.
                        Convallis arcu aliquam morbi sed lectus parturient quam
                        justo. Blandit ultrices aliquam gravida pellentesque
                        ornare. Imperdiet magna habitant in erat massa nunc,
                        tellus. Id tellus, nec, pellentesque non turpis
                        eleifend.
                        <br />
                        <br />
                        Lacus, adipiscing gravida nisl id congue bibendum enim.
                        Ut molestie nunc habitasse mattis. Justo, augue nibh
                        aliquam tempus mi suspendisse senectus cras. Quam
                        tempor, curabitur laoreet tortor sem mattis. Tempus,
                        morbi sed porttitor adipiscing. Nunc at leo pellentesque
                        non laoreet leo massa eget. Imperdiet sed nulla in amet
                        semper imperdiet velit quis vulputate. Justo lectus
                        pellentesque morbi dictumst. Viverra libero cras
                        pellentesque ipsum. Proin et nunc felis pretium odio
                        lacus, faucibus. Posuere et nulla id interdum eros,
                        fusce risus. Leo eget nunc integer purus integer
                        convallis enim suspendisse porta. Nunc libero faucibus
                        non sem aliquet ut.
                        <br />
                        <br />
                        Pellentesque morbi cras enim sapien, pretium faucibus
                        amet non. Volutpat laoreet tristique vulputate urna,
                        ornare libero ut. Egestas elementum feugiat hendrerit
                        amet, tortor. Tempus, duis tortor amet bibendum aliquet
                        ultrices id molestie.{" "}
                      </Text>
                    </Column>
                  </Column>
                  <Column className="bg-white_A700 border border-black_900_0c border-solid justify-center lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] lg:p-[13px] xl:p-[16px] 2xl:p-[19px] 3xl:p-[22px] rounded-radius15 w-[100%]">
                    <Text
                      className="capitalize lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] text-blue_700 w-[auto]"
                      variant="body2"
                    >
                      My Intro Video
                    </Text>
                    <Column className="bg-bluegray_101 items-center justify-start 3xl:mb-[11px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] rounded-radius1365 w-[100%]">
                      <Column
                        className="bg-cover bg-repeat items-center justify-start lg:p-[136px] xl:p-[171px] 2xl:p-[192px] 3xl:p-[230px] rounded-radius1365 w-[100%]"
                        style={{
                          backgroundImage: "url('images/img_group686.png')",
                        }}
                      >
                        <Button
                          className="flex lg:h-[34px] xl:h-[43px] 2xl:h-[48px] 3xl:h-[58px] items-center justify-center mb-[1px] rounded-radius50 lg:w-[33px] xl:w-[42px] 2xl:w-[47px] 3xl:w-[57px]"
                          size="xlIcn"
                                ...
                                <Column className="justify-start mt-[3px] w-[79%]">
                                  ...
                                  <Row className="font-poppins items-center justify-between lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] w-[100%]">
                                    ...
                                    <Button
                                      ...
                                      variant="OutlineBlue7001_2"
                                    >
                                      <div className="common-pointer bg-transparent font-medium xl:text-[10px] 2xl:text-[11px] 3xl:text-[13px] lg:text-[8px]">
                                        Endorse
                                      </div>
                                    </Button>
                                  </Row>
        ...
        <Column className="items-end lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] 2xl:pl-[104px] 3xl:pl-[125px] lg:pl-[74px] xl:pl-[93px] w-[100%]">
          <Column className="justify-start w-[100%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_19.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileGeneralSectionPage;
