...
const IMARNFrontendWebsiteAIOProfileSocialSectionSubscribedChannelsPage =
  () => {
    const navigate = useNavigate();

    function handleNavigate127() {
      navigate("/imarnfrontendwebsiteaioprofilesocialsectionlikedpages");
    }
    ...
    function handleNavigate142() {
      navigate("/imarnfrontendwebsiteaioprofilesocialsectionfollowing");
    }
      ...
      <>
        <Column className="bg-white_A700 font-prompt items-center justify-start mx-[auto] pt-[2px] w-[100%]">
          ...
          <Column className="font-poppins items-center justify-start overflow-auto w-[100%]">
                ...
                <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                  <Row className="items-center justify-between w-[99%]">
                    <Column className="items-center w-[23%]">
                      ...
                      <Img
                        src="images/img_emailphonepay_16.svg"
            ...
            <Column className="items-center justify-start lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[85%]">
              <Column className="items-center justify-start w-[100%]">
                ...
                <Row className="bg-white_A700 border border-black_900_0c border-solid items-start justify-center lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius15 shadow-bs12 w-[68%]">
                  ...
                  <Column
                    className="common-pointer items-center justify-start lg:ml-[16px] xl:ml-[20px] 2xl:ml-[22px] 3xl:ml-[27px] mt-[1px] w-[10%]"
                ...
                <Row className="items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                  <Column className="bg-white_A700 border border-black_900_0c border-solid items-end justify-start lg:py-[11px] xl:py-[14px] 2xl:py-[16px] 3xl:py-[19px] rounded-radius15 w-[68%]">
                    <Column className="justify-start mb-[3px] w-[100%]">
                      <Column className="justify-start lg:ml-[13px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] w-[98%]">
                        <Stack className="2xl:h-[1076px] 3xl:h-[1292px] lg:h-[765px] xl:h-[957px] w-[100%]">
                          <Stack className="absolute 3xl:h-[1040px] lg:h-[616px] xl:h-[771px] 2xl:h-[867px] top-[0] w-[100%]">
                            <Row className="absolute items-center justify-center right-[34%] rounded-radius4 top-[0] w-[15%]">
                              <Column className="bg-gray_203 border border-black_900_0f border-solid items-center lg:p-[3px] 2xl:p-[4px] xl:p-[4px] 3xl:p-[5px] rounded-radius4 w-[43%]">
                                <Text
                              ...
                              <Text
                                className="lg:ml-[11px] xl:ml-[14px] 2xl:ml-[16px] 3xl:ml-[19px] XAxis"
                                variant="body12"
                              >
                                12 Of 72 Results
                              </Text>
                            ...
                            <Slider
                              ...
                              centerMode
                              ref={sliderRef}
                              className="absolute font-prompt top-[3%] w-[100%]"
                              items={[...Array(15)].map(() => (
                                <React.Fragment key={Math.random()}>
                                  <Stack className="font-poppins gridlocation">
                          ...
                          <Column className="absolute bottom-[0] inset-x-[0] items-center justify-start mx-[auto] w-[32%]">
                            <Column className="bg-white_A700 border border-gray_201 border-solid justify-center lg:p-[10px] xl:p-[12px] 2xl:p-[14px] 3xl:p-[17px] rounded-radius10 shadow-bs6 w-[100%]">
                              <Row className="items-center lg:mt-[220px] xl:mt-[275px] 2xl:mt-[309px] 3xl:mt-[371px] w-[63%]">
                                <Button
                                  className="flex lg:h-[21px] xl:h-[26px] 2xl:h-[29px] 3xl:h-[35px] items-center justify-center rounded-radius50 lg:w-[20px] xl:w-[25px] 2xl:w-[28px] 3xl:w-[34px]"
                                  size="mdIcn"
                                  variant="icbOutlineBlack90033"
                              ...
                              <Line className="bg-black_900_20 h-[1px] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[100%]" />
                              <Row className="items-center justify-between lg:mb-[3px] 2xl:mb-[4px] xl:mb-[4px] 3xl:mb-[5px] xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[100%]">
                          ...
                          <Column className="absolute bottom-[0] items-center justify-start left-[0] w-[32%]">
                            <Column className="bg-white_A700 border border-gray_201 border-solid justify-center lg:p-[10px] xl:p-[12px] 2xl:p-[14px] 3xl:p-[17px] rounded-radius10 shadow-bs6 w-[100%]">
                              <Column className="items-center justify-start lg:mt-[220px] xl:mt-[275px] 2xl:mt-[309px] 3xl:mt-[371px] w-[80%]">
                                <Column className="justify-start w-[100%]">
                        ...
                        <Grid className="lg:gap-[12px] xl:gap-[15px] 2xl:gap-[17px] 3xl:gap-[20px] grid grid-cols-2 lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[66%]">
                      ...
                      <Column className="justify-start lg:mt-[33px] xl:mt-[41px] 2xl:mt-[46px] 3xl:mt-[56px] rounded-radius6 w-[68%]">
                        <Line className="bg-black_900_14 h-[1px] w-[100%]" />
                        <Button
            ...
            <Column className="justify-start lg:mt-[54px] xl:mt-[67px] 2xl:mt-[76px] 3xl:mt-[91px] w-[96%]">
              ...
              >
                ...
                <Stack
                  className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                  style={{ backgroundImage: "url('images/img_adv_36.png')" }}
                >
                  <Img
...
export default IMARNFrontendWebsiteAIOProfileSocialSectionSubscribedChannelsPage;
