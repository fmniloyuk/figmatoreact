...
const IMARNFrontendWebsiteSingleServicePageCheckoutScenerio2FundWalletModalboxPage =
  () => {
    ...
    return (
      <>
        <Column className="font-poppins items-center justify-start mx-[auto] lg:p-[40px] xl:p-[50px] 2xl:p-[57px] 3xl:p-[68px] w-[100%]">
          <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-start lg:mb-[265px] xl:mb-[332px] 2xl:mb-[373px] 3xl:mb-[448px] lg:pb-[20px] xl:pb-[25px] 2xl:pb-[28px] 3xl:pb-[34px] rounded-radius10 w-[43%]">
            <Input
            ...
            ></Input>
            <Column className="items-center justify-start lg:pt-[13px] xl:pt-[16px] 2xl:pt-[19px] 3xl:pt-[22px] lg:px-[13px] xl:px-[16px] 2xl:px-[19px] 3xl:px-[22px] w-[100%]">
              <Column className="justify-start pt-[4px] w-[100%]">
                ...
                <Row className="items-center justify-between xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[100%]">
                  <Button
                    className="capitalize font-semibold xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px] lg:text-[9px] text-center w-[37%]"
                  ...
                  >
                    <div className="common-pointer bg-transparent capitalize font-semibold xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px] lg:text-[9px]">
                      Add another card
                    </div>
                  </Button>
                </Row>
...
export default IMARNFrontendWebsiteSingleServicePageCheckoutScenerio2FundWalletModalboxPage;
