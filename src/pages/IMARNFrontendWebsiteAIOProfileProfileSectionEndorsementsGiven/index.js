...
const IMARNFrontendWebsiteAIOProfileProfileSectionEndorsementsGivenPage =
  () => {
    ...
    function handleNavigate23() {
      navigate("/imarnfrontendwebsiteaioprofileprofilesectionworkexperience");
    }
    function handleNavigate24() {
      navigate("/imarnfrontendwebsiteaioprofileprofilesectioneducation");
    }
    function handleNavigate25() {
      navigate("/imarnfrontendwebsiteaioprofileprofilesectionskills");
    }
    function handleNavigate26() {
      navigate("/imarnfrontendwebsiteaioprofileprofilesectionacheivements");
    }
    function handleNavigate39() {
      navigate("/imarnfrontendwebsiteaioprofilesocialsectiontimeline");
    }
        ...
        <Column className="bg-white_A700 font-poppins items-center justify-start mx-[auto] overflow-auto pt-[2px] w-[100%]">
                ...
                <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                  <Row className="items-center justify-between w-[99%]">
                    <Column className="items-center w-[23%]">
                      ...
                      <Img
                        src="images/img_emailphonepay_6.svg"
          ...
          <Column className="justify-start lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[85%]">
            <Row className="items-center ml-[1px] w-[63%]">
              ...
              <Button
                className="capitalize font-medium ml-[2px] lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-center w-[15%]"
                shape="CircleBorder12"
                size="lg"
                variant="GradientDeeporangeA400Pink900"
              >
              ...
              <Button
                className="common-pointer capitalize font-medium ml-[2px] lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-bluegray_400 text-center w-[13%]"
            ...
            <Column className="items-center justify-start lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] 3xl:pb-[1173px] lg:pb-[694px] xl:pb-[869px] 2xl:pb-[977px] w-[100%]">
              <Column className="items-center justify-start w-[100%]">
                <Line className="bg-black_900_14 h-[1px] w-[100%]" />
                <Row className="bg-white_A700 border border-black_900_0c border-solid items-start justify-center lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius15 shadow-bs12 w-[55%]">
                  <Column className="items-center justify-start lg:ml-[13px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] mt-[1px] w-[12%]">
                    <Img
                  ...
                  <Column
                    className="common-pointer items-center justify-start lg:ml-[20px] xl:ml-[25px] 2xl:ml-[28px] 3xl:ml-[34px] mt-[1px] w-[17%]"
                    onClick={handleNavigate23}
                  >
                    <Img
                      src="images/img_grid_24X24.svg"
                      className="file_One1"
                      alt="grid"
                    />
                  ...
                  <Column
                    className="common-pointer items-center justify-start lg:ml-[20px] xl:ml-[25px] 2xl:ml-[28px] 3xl:ml-[34px] mt-[1px] w-[10%]"
                  ...
                  <Column
                    className="common-pointer items-center justify-start lg:ml-[20px] xl:ml-[25px] 2xl:ml-[28px] 3xl:ml-[34px] w-[5%]"
                  ...
                  <Column
                    className="common-pointer items-center justify-start lg:ml-[20px] xl:ml-[25px] 2xl:ml-[28px] 3xl:ml-[34px] mt-[1px] w-[13%]"
                  ...
                  <Column className="items-center justify-start lg:ml-[20px] xl:ml-[25px] 2xl:ml-[28px] 3xl:ml-[34px] lg:mr-[13px] xl:mr-[16px] 2xl:mr-[19px] 3xl:mr-[22px] w-[15%]">
                    <Img
                      src="images/img_megaphone_20X20.svg"
                      className="file_One1"
                      alt="megaphone One"
                ...
                <Row className="items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                  <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-end 2xl:p-[10px] 3xl:p-[12px] lg:p-[7px] xl:p-[9px] rounded-radius15 w-[69%]">
                    <Column className="items-center justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[99%]">
                      <Row className="items-start justify-between w-[99%]">
                        <Text className="roweducation_one" variant="body2">
                          Endorsements
                        </Text>
                        <Button
                          ...
                          rightIcon={
                            <Img
                              src="images/img_download_12X12.svg"
                              className="text-center lg:w-[8px] lg:h-[9px] lg:ml-[3px] xl:w-[10px] xl:h-[11px] xl:ml-[4px] 2xl:w-[11px] 2xl:h-[12px] 2xl:ml-[4px] 3xl:w-[13px] 3xl:h-[14px] 3xl:ml-[5px]"
                              alt="download"
                            />
                          }
                          shape="RoundedBorder4"
                      ...
                      <Column className="items-center justify-start lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[100%]">
                        <Stack className="lg:h-[25px] xl:h-[31px] 2xl:h-[35px] 3xl:h-[42px] w-[98%]">
                          <Text
                            className="common-pointer absolute left-[0] top-[0] rowcalendar1"
                            variant="body10"
                            onClick={handleNavigate22}
                          >
                            Received
                          </Text>
                          <Stack className="absolute lg:h-[26px] xl:h-[32px] 2xl:h-[36px] 3xl:h-[43px] w-[100%]">
                            <Line className="absolute bg-black_900_14 bottom-[3%] h-[1px] w-[100%]" />
                            <Column className="absolute justify-start left-[10%] w-[5%]">
                              <Text className="Received" variant="body10">
                                Given
                              </Text>
                              <Line className="bg-blue_700 h-[2px] ml-[3px] lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[93%]" />
                            </Column>
                          </Stack>
                        </Stack>
                        <List
                          ...
                          orientation="vertical"
                        >
                          <Column className="listellipsetwentyeight1">
                            <Column className="justify-start w-[100%]">
                              <Row className="items-start w-[33%]">
                                ...
                                />
                                <Column className="justify-start 3xl:ml-[11px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] mt-[1px] w-[78%]">
                                  <Text className="AndrewHalls" variant="body9">
                                    Andrew Halls
                                  </Text>
                                  <Text
                                    className="font-poppins lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] rowuser"
                                    variant="body12"
                                  >
                              ...
                              <Text
                                className="columnellipsetwentyeight"
                                variant="body12"
                              >
                                Neque, feugiat iaculis purus ullamcorper urna
                                vitae. Dignissim eget morbi neque, massa
                                habitant et sagittis posuere donec. Habitasse a,
                                tincidunt nulla vitae pellentesque phasellus.
                                Mauris facilisis dolor facilisis at id
                                sollicitudin pellentesque amet dolor. Facilisis
                                ultricies faucibus congue id nisl ac nulla. Sed
                                eget volutpat adipiscing tincidunt. Tortor
                                tempor, mi dui dictum est suspendisse magna
                                fermentum. Sed duis commodo massa pharetra, enim
                                sit facilisis. Lectus fames est, magna quis
                                nulla.{" "}
                              </Text>
                              <Line className="bg-black_900_14 h-[1px] lg:ml-[12px] xl:ml-[15px] 2xl:ml-[17px] 3xl:ml-[20px] lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[98%]" />
                            </Column>
                          </Column>
                          <Column className="listellipsetwentyeight1">
                            <Column className="justify-start w-[100%]">
                              <Row className="items-start w-[33%]">
                                ...
                                />
                                <Column className="justify-start 3xl:ml-[11px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] mt-[3px] w-[78%]">
                                  <Text className="AndrewHalls" variant="body9">
                                    Michael Rays
                                  </Text>
                                  <Text
                                    className="language_One"
                                    variant="body12"
                                  >
                                    {"Sales and Marketing at  <Company>"}
                                  </Text>
                              ...
                              <Text
                                ...
                                variant="body12"
                              >
                                Fusce pharetra hendrerit ultrices ac facilisis
                                in tincidunt ullamcorper. Nisi sem bibendum diam
                                morbi risus urna volutpat mattis elementum. Ut
                                nunc pellentesque arcu pellentesque lobortis
                                bibendum sem tempus nibh. Vulputate imperdiet
                                netus tincidunt metus a gravida quam bibendum.
                                Cursus turpis felis, feugiat quam gravida.
                                Viverra lorem sed lobortis aliquet egestas odio
                                phasellus ullamcorper magnis. Blandit nunc,
                                tristique ultrices lectus etiam non aliquet
                                dictumst. Semper massa risus pharetra.
                              </Text>
                              <Line className="bg-black_900_14 h-[1px] lg:ml-[12px] xl:ml-[15px] 2xl:ml-[17px] 3xl:ml-[20px] lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[98%]" />
                            </Column>
                          </Column>
                          <Column className="lg:pb-[12px] xl:pb-[16px] 2xl:pb-[18px] 3xl:pb-[21px] lg:pr-[12px] xl:pr-[16px] 2xl:pr-[18px] 3xl:pr-[21px] listellipsetwentyeight1">
                            <Row className="items-start justify-between mb-[1px] w-[100%]">
                              <Img
                                src="images/img_ellipse28_6.png"
                                className="lg:h-[34px] xl:h-[43px] 2xl:h-[48px] 3xl:h-[58px] rounded-radius50 lg:w-[33px] xl:w-[42px] 2xl:w-[47px] 3xl:w-[57px]"
                                alt="EllipseTwentyEight Two"
                              />
                              <Column className="justify-start mt-[3px] w-[93%]">
                                <Text className="AndrewHalls" variant="body9">
                                  Jiremy Thomson
                                </Text>
                                <Text className="language_One" variant="body12">
                                  {"Sales and Marketing at  <Company>"}
                                </Text>
                                <Text
                                  className="font-normal font-poppins leading-[140.00%] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] not-italic text-bluegray_400 w-[100%]"
                                  variant="body12"
                                >
                                  Sed donec vulputate nunc, vel sollicitudin
                                  donec proin. Montes, nunc, semper tortor, in.
                                  Pellentesque gravida fringilla nunc sapien.
                                  Lorem tortor nisi accumsan sed donec elit.
                                  Ultrices tincidunt volutpat convallis eget
                                  malesuada id lacus. Elit sit tellus congue
                                  massa ultricies porta euismod. Diam elementum
                                  adipiscing porttitor cursus. Malesuada donec
                                  etiam id pretium sit vitae arcu in metus. Enim
                                  pharetra mauris molestie tellus enim facilisis
                                  pellentesque neque, nec. Adipiscing vitae
                                  massa odio arcu justo, vitae.{" "}
                                </Text>
                              </Column>
                            </Row>
                          </Column>
                      ...
                      <Stack className="lg:h-[29px] xl:h-[36px] 2xl:h-[41px] 3xl:h-[49px] w-[98%]">
                        <Line className="absolute bg-black_900_14 h-[1px] top-[0] w-[100%]" />
                        <Button
                          className="2xl:mx-[324px] 3xl:mx-[388px] absolute flex inset-x-[41%] items-center justify-center lg:mx-[230px] text-center w-[18%] xl:mx-[288px]"
                          rightIcon={
                            <Img
                              src="images/img_arrowdown_16X12.svg"
                              className="text-center left-[1%] absolute lg:w-[8px] lg:ml-[6px] xl:w-[10px] xl:ml-[7px] 2xl:w-[11px] 2xl:ml-[8px] 3xl:w-[13px] 3xl:ml-[10px]"
                              alt="arrow_down"
                            />
                          }
                          shape="RoundedBorder4"
          ...
          <Column className="items-end lg:mt-[18px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] 2xl:pl-[104px] 3xl:pl-[125px] lg:pl-[74px] xl:pl-[93px] w-[100%]">
            <Column className="justify-start w-[100%]">
              ...
              >
                ...
                <Stack
                  className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                  style={{ backgroundImage: "url('images/img_adv_26.png')" }}
                >
                  <Img
...
export default IMARNFrontendWebsiteAIOProfileProfileSectionEndorsementsGivenPage;
