...
const IMARNFrontendWebsiteAIOProfileAssetsVSpeakerPage = () => {
    ...
    <>
      <Column className="bg-white_A700 font-prompt items-center justify-start mx-[auto] pt-[2px] w-[100%]">
        ...
        <Column className="font-poppins items-center justify-start overflow-auto w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_25.svg"
                ...
                <Column className="font-poppins items-center justify-start w-[100%]">
                  <Column className="items-center justify-start w-[100%]">
                    ...
                    <Row className="font-prompt items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                      <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-end 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius15 w-[68%]">
                        <Row className="items-center justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[98%]">
                          <List
                            className="lg:gap-[31px] xl:gap-[39px] 2xl:gap-[44px] 3xl:gap-[53px] grid grid-cols-2 min-h-[auto] w-[47%]"
                          ...
                          >
                            ...
                            <Column className="bg-white_A700 border border-black_900_26 border-solid items-center justify-center lg:p-[15px] xl:p-[19px] 2xl:p-[21px] 3xl:p-[26px] rounded-radius15 w-[100%]">
                              <Text
                                className="OneHundredEleven"
                                variant="body2"
                              >
                                1.2K
                              </Text>
                          ...
                          <List
                            className="lg:gap-[31px] xl:gap-[38px] 2xl:gap-[43px] 3xl:gap-[52px] grid grid-cols-2 min-h-[auto] w-[47%]"
                            orientation="horizontal"
                          >
                            <Column className="listonehundrednine">
                              <Text className="Iamlookingfo" variant="body2">
                        ...
                        >
                          <Column className="listvmarketstores">
                            <Column className="items-center justify-start w-[100%]">
                              <Row className="font-prompt items-center justify-between w-[99%]">
                                <Text
                              ...
                              <Row className="font-poppins items-center justify-between 3xl:mt-[11px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] w-[100%]">
                                <Stack className="lg:h-[423px] xl:h-[529px] 2xl:h-[595px] 3xl:h-[714px] w-[48%]">
                                      ...
                                      <Column className="font-poppins items-center justify-start lg:ml-[3px] 2xl:ml-[4px] xl:ml-[4px] 3xl:ml-[5px] w-[99%]">
                                        <Row className="items-center w-[100%]">
                                          <Stack className="lg:h-[31px] xl:h-[39px] 2xl:h-[43px] 3xl:h-[52px] lg:w-[30px] xl:w-[38px] 2xl:w-[42px] 3xl:w-[51px]">
                                            ...
                                            <Button
                                              className="absolute flex lg:h-[31px] xl:h-[39px] 2xl:h-[43px] 3xl:h-[52px] items-center justify-center rounded-radius50 top-[2%] w-[100%]"
                                              size="lgIcn"
                                              variant="icbOutlineBlack9000c1_2"
                                            >
                                              <Img
                                          ...
                                          <Column className="3xl:ml-[11px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] w-[29%]">
                                            <Text
                                      ...
                                      <Column className="font-poppins items-center justify-start lg:ml-[3px] 2xl:ml-[4px] xl:ml-[4px] 3xl:ml-[5px] w-[99%]">
                                        <Row className="items-center w-[100%]">
                                          <Stack className="lg:h-[31px] xl:h-[39px] 2xl:h-[43px] 3xl:h-[52px] lg:w-[30px] xl:w-[38px] 2xl:w-[42px] 3xl:w-[51px]">
                                            ...
                                            <Img
                                              src="images/img_ellipse16_45X45.png"
                                              className="absolute lg:h-[31px] xl:h-[39px] 2xl:h-[43px] 3xl:h-[52px] rounded-radius50 top-[2%] w-[100%]"
                                              alt="EllipseSixteen"
                                            />
                                          </Stack>
                              ...
                              <Button
                                className="2xl:mt-[14px] 3xl:mt-[17px] flex items-center justify-center lg:mt-[10px] text-center w-[18%] xl:mt-[12px]"
                                rightIcon={
                                  <Img
                          ...
                          <Line className="self-center w-[99%] h-[1px] bg-black_900_20" />
                          <Column className="listvmarketstores">
                            <Column className="items-center justify-start w-[100%]">
                              <Column className="items-center justify-start w-[100%]">
                                    ...
                                    <Column className="absolute bg-white_A700 border border-gray_201 border-solid bottom-[0] items-center justify-end lg:p-[10px] xl:p-[12px] 2xl:p-[14px] 3xl:p-[17px] rounded-radius10 shadow-bs6 w-[100%]">
                                      <Column className="justify-start lg:mb-[10px] xl:mb-[12px] 2xl:mb-[14px] 3xl:mb-[17px] lg:mt-[161px] xl:mt-[202px] 2xl:mt-[227px] 3xl:mt-[273px] w-[99%]">
                                        ...
                                        <Text
                                          ...
                                          variant="body7"
                                        >
                                          Dictum mi quis sed nibh nam faucibus
                                          et pellentesque. Arcu.
                                        </Text>
                                        <Row className="font-poppins items-center xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] w-[79%]">
                                          <Row className="items-end justify-evenly mb-[1px] w-[37%]">
                                            <Img
          ...
          />
          <Column className="font-poppins justify-start lg:mt-[142px] xl:mt-[177px] 2xl:mt-[200px] 3xl:mt-[240px] w-[96%]">
            <Text className="carouseladvlt" variant="body13">
              Sponsored Ads
            </Text>
            <List
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_45.png')" }}
              >
                <Img
          ...
          <Footer className="font-poppins lg:mt-[58px] xl:mt-[72px] 2xl:mt-[81px] 3xl:mt-[98px] w-[100%]" />
        </Column>
      </Column>
    </>
  );
...
export default IMARNFrontendWebsiteAIOProfileAssetsVSpeakerPage;
