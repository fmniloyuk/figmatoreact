...
const IMARNFrontendWebsiteAIOProfileAssetsVOrganizerPage = () => {
  ...
  return (
    <>
      <Column className="bg-white_A700 font-poppins items-center justify-end mx-[auto] overflow-auto py-[1px] w-[100%]">
        <Stack className="lg:h-[493px] xl:h-[616px] 2xl:h-[693px] 3xl:h-[832px] mt-[1px] w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_23.svg"
              ...
              <Column className="font-poppins items-center justify-start 3xl:pb-[1087px] lg:pb-[644px] xl:pb-[805px] 2xl:pb-[906px] w-[100%]">
                <Column className="items-center justify-start w-[100%]">
                  ...
                  <Row className="font-prompt items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                    <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-end xl:p-[11px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] rounded-radius15 w-[68%]">
                      <Column className="items-center justify-start lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] w-[98%]">
                        <Row className="items-center justify-between w-[100%]">
                          ...
                          <Column className="bg-white_A700 border border-black_900_26 border-solid items-center lg:p-[15px] xl:p-[19px] 2xl:p-[21px] 3xl:p-[26px] rounded-radius15 w-[21%]">
                            <Text className="OneHundredEleven" variant="body2">
                              111
                            </Text>
                            <Text
                              className="capitalize font-bold font-poppins my-[4px] text-gray_501 w-[auto]"
                              variant="body10"
                            >
                              Events Attendees
                            </Text>
                      ...
                      <Column className="items-center justify-start lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[8px] lg:mt-[19px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[33px] w-[100%]">
                        <Column className="justify-start w-[100%]">
                          <Column className="items-center justify-start w-[100%]">
                            <Row className="items-center justify-between w-[99%]">
                              <Text
                            ...
                            >
                              <Stack className="listrectanglesixtyfive_one">
                                <Column className="absolute bg-white_A700 border border-gray_201 border-solid bottom-[0] items-center justify-end lg:p-[10px] xl:p-[12px] 2xl:p-[14px] 3xl:p-[17px] rounded-radius10 shadow-bs6 w-[100%]">
                                  <Column className="justify-start lg:mb-[10px] xl:mb-[12px] 2xl:mb-[14px] 3xl:mb-[17px] lg:mt-[163px] xl:mt-[205px] 2xl:mt-[230px] 3xl:mt-[276px] w-[99%]">
                                    <Column className="font-poppins items-center justify-start w-[100%]">
                                      <Row className="items-start w-[100%]">
                                        ...
                                        />
                                        <Column className="items-center justify-start 3xl:ml-[11px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] mt-[4px] w-[29%]">
                                          <Text
                                        ...
                                        <Img
                                          ...
                                          className="VendorSilver1"
                                          alt="VendorSilver"
                                        />
                                        <Button
                                          className="flex lg:h-[20px] xl:h-[25px] 2xl:h-[28px] 3xl:h-[34px] items-center justify-center lg:ml-[12px] xl:ml-[16px] 2xl:ml-[18px] 3xl:ml-[21px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] lg:w-[19px] xl:w-[24px] 2xl:w-[27px] 3xl:w-[33px]"
                              ...
                              <Stack className="listrectanglesixtyfive_one">
                                <Column className="absolute bg-white_A700 border border-gray_201 border-solid bottom-[0] items-center justify-end lg:p-[11px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[19px] rounded-radius10 shadow-bs6 w-[100%]">
                                  <Column className="justify-start xl:mb-[11px] 2xl:mb-[12px] 3xl:mb-[14px] lg:mb-[8px] lg:mt-[162px] xl:mt-[203px] 2xl:mt-[228px] 3xl:mt-[274px] w-[100%]">
                                    <Column className="font-poppins items-center justify-start w-[100%]">
                                      <Row className="items-start w-[100%]">
                                        <Img
                                          src="images/img_rectangle65.png"
                          ...
                          <Column className="font-poppins items-center justify-start lg:ml-[251px] xl:ml-[315px] 2xl:ml-[354px] 3xl:ml-[425px] lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] rounded-radius6 w-[18%]">
                            <Button
        ...
        />
        <Column className="font-poppins items-end lg:mt-[19px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[33px] 2xl:pl-[104px] 3xl:pl-[125px] lg:pl-[74px] xl:pl-[93px] w-[100%]">
          <Column className="justify-start w-[100%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_43.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileAssetsVOrganizerPage;
