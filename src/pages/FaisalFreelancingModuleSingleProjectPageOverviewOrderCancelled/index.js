...
const FaisalFreelancingModuleSingleProjectPageOverviewOrderCancelledPage =
  () => {
                ...
                <Column className="items-center justify-start w-[66%]">
                  <Column className="items-center justify-start w-[100%]">
                    <Stack className="bg-white_A700 border border-bluegray_102 border-solid 2xl:h-[102px] 3xl:h-[122px] lg:h-[72px] xl:h-[90px] lg:px-[10px] xl:px-[12px] 2xl:px-[14px] 3xl:px-[17px] rounded-radius15 w-[100%]">
                      <Column className="absolute border border-blue_700 border-solid h-[max-content] inset-[0] justify-center m-[auto] pt-[4px] px-[4px] w-[95%]">
                        <Text
                          className="font-semibold lg:ml-[3px] 2xl:ml-[4px] xl:ml-[4px] 3xl:ml-[5px] text-black_900 w-[auto]"
                          variant="body9"
                        >
                          Your Project Started.
                        </Text>
                        <Text
                          className="lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] rowclock"
                          variant="body10"
                        >
                          {"We notified <Buyer Name> about your order."}
                        </Text>
                        <Text
                          className="lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] rowclock"
                          variant="body10"
                            ...
                            <Row className="items-start justify-between lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[100%]">
                              ...
                              <Column className="justify-start w-[92%]">
                                <Row className="items-end justify-between w-[100%]">
                                  <Row className="items-start justify-between mb-[1px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] w-[51%]">
                                    <Text
                                      ...
                                      <Column className="lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[8px] pb-[4px] pr-[4px] w-[98%]">
                                        ...
                                        >
                                          ...
                                          <span className="text-gray_501 font-poppins font-normal not-italic lg:text-[9px] xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px]">
                                            14-Dec-2022 11:38 AM - 21-Dec-2022
                                            7:11 PM
                                          </span>
                                        </Text>
                                        <Text
                        ...
                        <Row className="border border-blue_700 border-solid items-start justify-evenly lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                          ...
                          <Column className="justify-start w-[98%]">
                            <Img
                              ...
                              alt="line Four"
                            />
                            <Row className="items-center lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[77%]">
                              ...
                              <Row className="items-start justify-evenly lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] w-[90%]">
                                <Text
                                  className="font-semibold text-bluegray_400 w-[auto]"
                                  variant="body10"
                                >
                                  <span className="text-bluegray_400 font-poppins lg:text-[9px] xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px]">
                                    Your Project is cancelled. If you need to
                                    contact{" "}
                                  </span>
                                  <span className="text-blue_700 font-poppins lg:text-[9px] xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px]">
                                    {"<Seller Name>"}
...
export default FaisalFreelancingModuleSingleProjectPageOverviewOrderCancelledPage;
