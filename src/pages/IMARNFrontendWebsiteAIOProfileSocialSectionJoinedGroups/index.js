...
const IMARNFrontendWebsiteAIOProfileSocialSectionJoinedGroupsPage = () => {
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_15.svg"
              ...
              <Column className="bg-white_A700 border border-black_900_0c border-solid items-end justify-start lg:py-[11px] xl:py-[14px] 2xl:py-[16px] 3xl:py-[19px] rounded-radius15 w-[68%]">
                <Column className="justify-start mb-[3px] w-[100%]">
                  <Row className="items-center justify-end ml-[auto] rounded-radius4 w-[15%]">
                    ...
                    <Text
                      className="lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] XAxis"
                      variant="body12"
                    >
                      12 Of 56 Results
                    </Text>
                  ...
                  <Column className="font-prompt justify-start lg:ml-[13px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] 3xl:mt-[11px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] w-[98%]">
                    <Stack className="2xl:h-[1054px] 3xl:h-[1264px] lg:h-[749px] xl:h-[937px] w-[100%]">
                      <Slider
                        autoPlay
                      ...
                      />
                      <Column className="absolute bg-white_A700 border border-gray_201 border-solid bottom-[0] font-poppins inset-x-[0] items-center justify-end mx-[auto] xl:p-[11px] 2xl:p-[13px] 3xl:p-[16px] lg:p-[9px] rounded-radius10 shadow-bs6 w-[32%]">
                        <Column className="justify-start lg:mb-[4px] 2xl:mb-[5px] xl:mb-[5px] 3xl:mb-[6px] lg:mt-[220px] xl:mt-[276px] 2xl:mt-[310px] 3xl:mt-[372px] w-[100%]">
                          <Row className="items-end w-[58%]">
                            <Button
                              className="flex lg:h-[21px] xl:h-[26px] 2xl:h-[29px] 3xl:h-[35px] items-center justify-center rounded-radius50 lg:w-[20px] xl:w-[25px] 2xl:w-[28px] 3xl:w-[34px]"
                              size="mdIcn"
                      ...
                      <Column className="absolute bg-white_A700 border border-gray_201 border-solid bottom-[0] font-poppins items-center justify-end left-[0] xl:p-[11px] 2xl:p-[13px] 3xl:p-[16px] lg:p-[9px] rounded-radius10 shadow-bs6 w-[32%]">
                        <Column className="justify-start mb-[3px] lg:mt-[220px] xl:mt-[276px] 2xl:mt-[310px] 3xl:mt-[372px] w-[100%]">
                          <Row className="items-end w-[58%]">
                            <Button
                              className="flex lg:h-[21px] xl:h-[26px] 2xl:h-[29px] 3xl:h-[35px] items-center justify-center rounded-radius50 lg:w-[20px] xl:w-[25px] 2xl:w-[28px] 3xl:w-[34px]"
                              size="mdIcn"
                    ...
                    <List
                      className="font-poppins gap-[0] min-h-[auto] lg:mt-[14px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[25px] w-[66%]"
                      orientation="vertical"
                    >
        ...
        <Column className="items-end lg:mt-[54px] xl:mt-[67px] 2xl:mt-[76px] 3xl:mt-[91px] 2xl:pl-[104px] 3xl:pl-[125px] lg:pl-[74px] xl:pl-[93px] w-[100%]">
          <Column className="justify-start w-[100%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_35.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileSocialSectionJoinedGroupsPage;
