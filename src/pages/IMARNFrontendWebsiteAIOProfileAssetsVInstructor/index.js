...
const IMARNFrontendWebsiteAIOProfileAssetsVInstructorPage = () => {
    ...
    <>
      <Column className="bg-white_A700 font-prompt items-center justify-start mx-[auto] pt-[2px] w-[100%]">
        ...
        <Column className="font-poppins items-center justify-start overflow-auto w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_20.svg"
          ...
          <Slider
            ...
            items={[...Array(6)].map(() => (
              <React.Fragment key={Math.random()}>
                <Column className="font-poppins items-center justify-start lg:pb-[153px] xl:pb-[192px] 2xl:pb-[216px] 3xl:pb-[259px] w-[100%]">
                  <Column className="items-center justify-start w-[100%]">
                    ...
                    <Row className="items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                      <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-end lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius15 w-[68%]">
                        <Column className="items-center justify-start 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[9px] w-[98%]">
                          <Column className="justify-start w-[100%]">
                            <Row className="items-center justify-between w-[100%]">
                              <List
                                className="lg:gap-[31px] xl:gap-[39px] 2xl:gap-[44px] 3xl:gap-[53px] grid grid-cols-2 min-h-[auto] w-[48%]"
                                orientation="horizontal"
                              >
                                <Column className="listonehundrednine">
                                  <Text
                                    className="Iamlookingfo"
                                    variant="body2"
                                  >
                                    109
                                  </Text>
                                  <Text
                                    className="Followers_One"
                                    variant="body10"
                                  >
                                    Courses
                                  </Text>
                              ...
                              <Column className="bg-white_A700 border border-black_900_26 border-solid items-center lg:p-[16px] xl:p-[20px] 2xl:p-[22px] 3xl:p-[27px] rounded-radius15 w-[19%]">
                                <Text className="Iamlookingfo" variant="body2">
                                  101
                                </Text>
                                <Text
                        ...
                        <Column className="items-center justify-start mb-[1px] lg:mt-[19px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[33px] w-[100%]">
                          <Column className="justify-start w-[100%]">
                            <Row className="font-prompt items-start justify-between w-[100%]">
                              <Text
                                className="rowvcollegecours"
                                variant="body5"
                              >
                                V-College Courses
                              </Text>
                            ...
                            <List
                              ...
                              orientation="horizontal"
                            >
                              <Column className="listenroll">
                                <Column className="bg-gray_401 items-center justify-start rounded-bl-[0] rounded-br-[0] rounded-tl-[20px] rounded-tr-[20px] w-[100%]">
                                  <Column
                                    className="bg-cover bg-repeat justify-start lg:py-[10px] xl:py-[12px] 2xl:py-[14px] 3xl:py-[17px] rounded-bl-[0] rounded-br-[0] rounded-tl-[15px] rounded-tr-[15px] w-[100%]"
                                    style={{
                                      backgroundImage:
                                  ...
                                  >
                                    <Button
                                      className="capitalize font-semibold lg:ml-[223px] xl:ml-[279px] 2xl:ml-[314px] 3xl:ml-[377px] xl:text-[10px] 2xl:text-[11px] 3xl:text-[13px] lg:text-[8px] text-center w-[16%]"
                                      shape="CircleBorder12"
                                      size="sm"
                                      variant="FillBlue700"
                                    >
                                    ...
                                    <Img
                                      ...
                                      className="GroupFiftyOne5"
                                      alt="GroupFiftyOne"
                                    />
                                  </Column>
                                </Column>
                                <Column className="items-center justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] lg:pb-[3px] 2xl:pb-[4px] xl:pb-[4px] 3xl:pb-[5px] w-[90%]">
                                  <Column className="justify-start w-[100%]">
                                    <Column className="items-center justify-start w-[100%]">
                                    ...
                                    <Text
                                      className="columndictummiquis2"
                                      variant="body7"
                                    >
                                      Dictum mi quis sed nibh nam faucibus et
                                      pellentesque. Arcu.
                                    </Text>
                                    <Row className="items-center xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] w-[80%]">
                                    ...
                                    <Row className="items-start 3xl:mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] w-[85%]">
                                      <Row className="items-start justify-between w-[64%]">
                                        <Row className="items-start justify-evenly w-[50%]">
                                          <Img
                                            src="images/img_clock_16X16.svg"
                                            className="calendar"
                                            alt="clock One"
                                          />
                                          <Text
                                            className="rowclock_one1"
                                            variant="body12"
                                          >
                                            9Hrs. 25Mins
                                          </Text>
                                        </Row>
                                        <Row className="items-start mt-[2px] w-[43%]">
                                          <Img
                                      ...
                                      <Row className="items-center lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] mt-[1px] w-[31%]">
                                        <Img
                                          src="images/img_user.svg"
                                          className="clock"
                                          alt="user One"
                                    ...
                                    <Line className="bg-black_900_0c h-[1px] 3xl:mt-[11px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] w-[100%]" />
                                    <Row className="items-start xl:mt-[11px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] w-[31%]">
                                      <Img
                                        src="images/img_volume.svg"
                                        className="file_One"
                                        alt="volume One"
                              ...
                              <Column className="listenroll">
                                <Column className="bg-gray_401 items-center justify-start rounded-bl-[0] rounded-br-[0] rounded-tl-[20px] rounded-tr-[20px] w-[100%]">
                                  <Column
                                    ...
                                    style={{
                                      backgroundImage:
                                        "url('images/img_group1239.png')",
                                    }}
                                  >
                                    <Column className="items-center justify-start lg:ml-[212px] xl:ml-[266px] 2xl:ml-[299px] 3xl:ml-[359px] w-[20%]">
                                      <Button
                                ...
                                <Column className="items-center justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] lg:pb-[3px] 2xl:pb-[4px] xl:pb-[4px] 3xl:pb-[5px] w-[90%]">
                                  <Column className="justify-start w-[100%]">
                                    ...
                                    <Line className="bg-black_900_0c h-[1px] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[100%]" />
                                    <Row className="items-start 3xl:mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] w-[84%]">
                                      <Row className="items-start justify-between w-[64%]">
                                        <Row className="items-start justify-evenly w-[48%]">
                                          <Img
                                            src="images/img_clock_16X16.svg"
                                            className="calendar"
                                            alt="clock One One"
          ...
          />
          <Column className="font-poppins justify-start lg:mt-[414px] xl:mt-[518px] 2xl:mt-[583px] 3xl:mt-[699px] w-[96%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_40.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileAssetsVInstructorPage;
