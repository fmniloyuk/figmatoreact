...
const IMARNFrontendWebsiteAIOProfileSponsorshipSponsoredByPage = () => {
  const navigate = useNavigate();

  function handleNavigate169() {
    navigate("/imarnfrontendwebsiteaioprofilesponsorshipsponsoring");
  }
  ...
  return (
    <>
      <Column className="bg-white_A700 font-poppins items-center justify-start mx-[auto] overflow-auto pt-[2px] w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_27.svg"
                    ...
                    <Column className="font-poppins items-center justify-start lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                      <Column className="justify-start w-[100%]">
                        <Row className="items-center w-[23%]">
                          <Text
                            className="border-blue_700 text-blue_700 rowsponsoredby"
                            variant="body10"
                          >
                            Sponsored By
                          </Text>
                          <Text
                            className="common-pointer border-gray_204 3xl:ml-[11px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] text-bluegray_400 rowsponsoredby"
                            variant="body10"
        ...
        <Column className="items-end 3xl:mt-[118px] lg:mt-[70px] xl:mt-[88px] 2xl:mt-[99px] 2xl:pl-[104px] 3xl:pl-[125px] lg:pl-[74px] xl:pl-[93px] w-[100%]">
          <Column className="justify-start w-[100%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_47.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileSponsorshipSponsoredByPage;
