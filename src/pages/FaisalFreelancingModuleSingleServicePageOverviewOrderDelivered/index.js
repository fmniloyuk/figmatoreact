...
const FaisalFreelancingModuleSingleServicePageOverviewOrderDeliveredPage =
  () => {
...
export default FaisalFreelancingModuleSingleServicePageOverviewOrderDeliveredPage;
