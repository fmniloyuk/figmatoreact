...
const IMARNFrontendWebsiteSingleProjectPageCheckoutScenerio2FundWalletModalboxAddAnotherCardPage =
  () => {
    return (
      <>
...
export default IMARNFrontendWebsiteSingleProjectPageCheckoutScenerio2FundWalletModalboxAddAnotherCardPage;
