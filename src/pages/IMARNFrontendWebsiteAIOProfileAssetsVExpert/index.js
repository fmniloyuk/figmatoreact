...
const IMARNFrontendWebsiteAIOProfileAssetsVExpertPage = () => {
  ...
  return (
    <>
      <Column className="bg-white_A700 font-poppins items-center justify-start mx-[auto] overflow-auto pt-[2px] w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_26.svg"
        ...
        <Slider
          ...
          items={[...Array(6)].map(() => (
            <React.Fragment key={Math.random()}>
              <Column className="font-poppins items-center justify-start 3xl:pb-[1125px] lg:pb-[666px] xl:pb-[833px] 2xl:pb-[937px] w-[100%]">
                    ...
                    <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-end lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius15 w-[68%]">
                      ...
                      <Column className="items-center justify-start mb-[1px] lg:mt-[19px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[33px] w-[100%]">
                        <Column className="justify-start w-[100%]">
                          ...
                          <List
                            className="font-poppins lg:gap-[12px] xl:gap-[15px] 2xl:gap-[17px] 3xl:gap-[20px] grid grid-cols-2 min-h-[auto] lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] w-[100%]"
                            ...
                            <Column className="listhire">
                              <Column className="bg-white_A700 border border-gray_201 border-solid items-center justify-start rounded-radius10 shadow-bs6 w-[100%]">
                                <Column
                                  ...
                                  style={{
                                    backgroundImage:
                                      "url('images/img_image_18.png')",
                                  }}
                                >
                                  <Column className="justify-start xl:mb-[110px] 2xl:mb-[123px] 3xl:mb-[148px] lg:mb-[88px] w-[100%]">
                                    <Button
                                      className="capitalize font-semibold lg:ml-[230px] xl:ml-[288px] 2xl:ml-[324px] 3xl:ml-[388px] xl:text-[10px] 2xl:text-[11px] 3xl:text-[13px] lg:text-[8px] text-center w-[13%]"
                                      shape="CircleBorder12"
                                      size="sm"
                                      variant="FillBlue700"
                                    >
                                ...
                                <Column className="items-center justify-end xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[91%]">
                                  <Column className="justify-end w-[100%]">
                                    ...
                                    <Text
                                      className="columnreportanalysis"
                                      variant="body7"
                                    >
                                      Report Analysis Digital Consultation
                                    </Text>
                                    <Row className="font-poppins items-center mr-[auto] lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[79%]">
                                    ...
                                    <Row className="font-poppins items-center ml-[1px] mr-[auto] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[81%]">
                                      <Button
                                    ...
                                    <Row className="font-poppins items-center mr-[auto] xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[81%]">
                                      <Row className="items-start justify-between w-[57%]">
                                        <Row className="items-start mt-[1px] w-[32%]">
                                          ...
                                          />
                                          <Text
                                            className="rowvolume7"
                                            variant="body12"
                                          >
                                            50.00
                                          </Text>
                                        </Row>
                                        <Row className="items-start justify-evenly w-[60%]">
                                          <Img
                                            src="images/img_clock_16X16.svg"
                                            className="calendar"
                                            alt="clock One"
                                      ...
                                      <Row className="items-start lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] w-[38%]">
                                        <Img
                              ...
                              <Column className="bg-white_A700 border border-gray_201 border-solid items-center justify-start rounded-radius10 shadow-bs6 w-[100%]">
                                ...
                                <Column className="items-center justify-end xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[91%]">
                                  <Column className="justify-end w-[100%]">
                                    ...
                                    <Line className="bg-black_900_0c h-[1px] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[99%]" />
                                    <Row className="font-poppins items-center mr-[auto] xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[82%]">
                                      <Row className="items-start justify-between w-[58%]">
                                        <Row className="items-start mt-[1px] w-[31%]">
                                          <Img
                                            src="images/img_volume.svg"
                                            className="clock"
                                            alt="volume Two"
                                        ...
                                        <Row className="items-start justify-evenly w-[61%]">
                                          <Img
                                            src="images/img_clock_16X16.svg"
                                            className="calendar"
                                            alt="clock One One"
                                      ...
                                      <Row className="items-start lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] w-[37%]">
                                        <Img
                                          src="images/img_checkmark.svg"
                                          className="calendar"
                                          alt="checkmark Two"
                          ...
                          <Button
                            className="2xl:ml-[348px] 2xl:mt-[119px] 3xl:ml-[418px] 3xl:mt-[142px] flex items-center justify-center lg:ml-[247px] lg:mt-[84px] text-center w-[18%] xl:ml-[310px] xl:mt-[105px]"
                            rightIcon={
                              <Img
        ...
        />
        <Column className="font-poppins items-end lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] 2xl:pl-[104px] 3xl:pl-[125px] lg:pl-[74px] xl:pl-[93px] w-[100%]">
          <Column className="justify-start w-[100%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_46.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileAssetsVExpertPage;
