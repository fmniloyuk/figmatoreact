...
const IMARNFrontendWebsiteAIOProfileProfileSectionAcheivementsPage = () => {
  ...
  return (
    <>
      <Column className="bg-white_A700 font-prompt items-center justify-start mx-[auto] pt-[2px] w-[100%]">
        ...
        <Column className="font-poppins items-center justify-start overflow-auto w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_4.svg"
            ...
            <Column className="items-center justify-start lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] 3xl:pb-[1173px] lg:pb-[694px] xl:pb-[869px] 2xl:pb-[977px] w-[100%]">
              <Column className="items-center justify-start w-[100%]">
                ...
                <Row className="bg-white_A700 border border-black_900_0c border-solid items-start justify-center lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius15 shadow-bs12 w-[55%]">
                  ...
                  <Column className="items-center justify-start lg:ml-[20px] xl:ml-[25px] 2xl:ml-[28px] 3xl:ml-[34px] mt-[1px] w-[13%]">
                    <Img
                ...
                <Row className="items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                  <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-end p-[4px] rounded-radius15 w-[69%]">
                    <Column className="justify-start lg:mt-[17px] xl:mt-[22px] 2xl:mt-[24px] 3xl:mt-[29px] w-[96%]">
                      ...
                      <Column className="items-center justify-start ml-[2px] lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[98%]">
                        <Column className="justify-start w-[100%]">
                          <Row className="items-center w-[28%]">
                            <Button
                              className="flex lg:h-[41px] xl:h-[51px] 2xl:h-[58px] 3xl:h-[69px] items-center justify-center lg:w-[40px] xl:w-[50px] 2xl:w-[57px] 3xl:w-[68px]"
                            ...
                            <Column className="lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] w-[68%]">
                              <Text
                                className="columntitleofthec"
                                variant="body10"
                              >
                                Country Best Achiever
                              </Text>
                              <Text className="rowglobe_one" variant="body12">
                                GSK
                              </Text>
                              <Text className="Cairo" variant="body12">
                                August 2022 | UAE
                              </Text>
                            </Column>
                          </Row>
                          <Column className="justify-start lg:ml-[50px] xl:ml-[63px] 2xl:ml-[71px] 3xl:ml-[85px] xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] w-[91%]">
                            <Row className="items-start justify-between w-[100%]">
                              <Text className="date" variant="body12">
                                Mauris eu morbi at non, aliquet. Tristique
                                facilisis neque luctus egestas in netus.
                                Volutpat risus malesuada.
                              </Text>
                              <Text className="rowglobe_one" variant="body12">
                                ...see more
                              </Text>
                            ...
                            <Img
                              src="images/img_rectangle84_70X100.png"
                              className="lg:h-[48px] xl:h-[60px] 2xl:h-[67px] 3xl:h-[81px] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] rounded-radius10 w-[13%]"
                              alt="RectangleEightyFour"
                            />
                          </Column>
                        </Column>
                      </Column>
                      <Line className="bg-black_900_14 h-[1px] lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[98%]" />
                      <Row className="items-center ml-[2px] lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] lg:pr-[132px] xl:pr-[165px] 2xl:pr-[185px] 3xl:pr-[222px] w-[59%]">
                        <Button
                          className="flex lg:h-[41px] xl:h-[51px] 2xl:h-[58px] 3xl:h-[69px] items-center justify-center lg:w-[40px] xl:w-[50px] 2xl:w-[57px] 3xl:w-[68px]"
                          shape="icbCircleBorder11"
                          size="2xlIcn"
                        ...
                        <Column className="lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] w-[76%]">
                          <Text className="carouseladvlt" variant="body10">
                            Star Of The Year Award
                          </Text>
                          <Text className="rowglobe" variant="body12">
                            Amazon
                          </Text>
                          <Text
                            className="3xl:mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] date"
                            variant="body12"
                          >
                            January 2021 | Grade: Excellent | UAE
                          </Text>
                        </Column>
                      </Row>
                      <Line className="bg-black_900_14 h-[1px] lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[98%]" />
                      <Column className="justify-start ml-[2px] lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[59%]">
                        <Column className="justify-start w-[52%]">
                          ...
                          <Img
                            src="images/img_rectangle84_70X100.png"
                            className="lg:h-[48px] xl:h-[60px] 2xl:h-[67px] 3xl:h-[81px] lg:ml-[50px] xl:ml-[63px] 2xl:ml-[71px] 3xl:ml-[85px] lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] rounded-radius10 w-[38%]"
                            alt="RectangleEightyFour One"
                          />
                        </Column>
                      </Column>
                      <Stack className="lg:h-[29px] xl:h-[36px] 2xl:h-[41px] 3xl:h-[49px] lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[98%]">
          ...
          <Column className="justify-start lg:mt-[18px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] w-[96%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_24.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileProfileSectionAcheivementsPage;
