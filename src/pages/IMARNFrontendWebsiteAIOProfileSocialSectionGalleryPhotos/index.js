...
const IMARNFrontendWebsiteAIOProfileSocialSectionGalleryPhotosPage = () => {
  const navigate = useNavigate();

  function handleNavigate52() {
    navigate("/imarnfrontendwebsiteaioprofilesocialsectiongalleryvideos");
  }
  function handleNavigate53() {
    navigate("/imranfrontendwebsiteaioprofilesocialsectiongalleryalbummodal");
  }
  ...
  return (
    <>
      <Column className="bg-white_A700 font-prompt items-center justify-start mx-[auto] pt-[2px] w-[100%]">
        ...
        <Column className="font-poppins items-center justify-start mt-[1px] overflow-auto w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_8.svg"
          ...
          <Column className="bg-white_A700 border border-black_900_0c border-solid justify-center lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] xl:p-[11px] 2xl:p-[13px] 3xl:p-[16px] lg:p-[9px] rounded-radius10 shadow-bs11 w-[85%]">
          ...
          <Column className="items-center justify-start lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] 3xl:pb-[1081px] lg:pb-[640px] xl:pb-[801px] 2xl:pb-[901px] w-[85%]">
            <Column className="items-center justify-start w-[100%]">
              ...
              <Row className="bg-white_A700 border border-black_900_0c border-solid items-start justify-center lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius15 shadow-bs12 w-[68%]">
                <Column
                  className="common-pointer items-center justify-start 3xl:ml-[11px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] w-[7%]"
                ...
                <Column className="items-center justify-start lg:ml-[16px] xl:ml-[20px] 2xl:ml-[22px] 3xl:ml-[27px] mt-[1px] w-[6%]">
                  <Img
                    src="images/img_airplane_24X23.svg"
                    className="globe_One"
                    alt="airplane"
                  />
              ...
              <Row className="items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-start lg:py-[13px] xl:py-[16px] 2xl:py-[19px] 3xl:py-[22px] rounded-radius15 w-[68%]">
                  <Column className="justify-start 3xl:mb-[11px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] w-[100%]">
                    <Row className="items-start lg:ml-[13px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] pb-[3px] w-[26%]">
                      <Column className="items-center justify-start w-[18%]">
                        ...
                        >
                          <Img
                            src="images/img_minimize_38X38.svg"
                            className="flex items-center justify-center lg:h-[17px] xl:h-[21px] 2xl:h-[23px] 3xl:h-[28px]"
                            alt="minimize One"
                          />
                        </Button>
                        <Text className="columnminimize_one" variant="body12">
                          Photos
                        </Text>
                      </Column>
                      <Column
                        className="common-pointer justify-start lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] w-[18%]"
                        onClick={handleNavigate52}
                      >
                        <Button
                          className="flex lg:h-[26px] xl:h-[33px] 2xl:h-[37px] 3xl:h-[44px] items-center justify-center ml-[1px] lg:w-[25px] xl:w-[32px] 2xl:w-[36px] 3xl:w-[43px]"
                          shape="icbCircleBorder20"
                          size="mdIcn"
                          variant="icbFillGray101"
                        >
                          <Img
                            src="images/img_videocamera_38X38.svg"
                            className="flex items-center justify-center lg:h-[17px] xl:h-[21px] 2xl:h-[23px] 3xl:h-[28px]"
                            alt="videocamera One"
                          />
                        </Button>
                        <Text
                          className="columnvideocamera_one"
                          variant="body12"
                        >
                          Videos
                        </Text>
                      </Column>
                      <Column className="justify-start lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] w-[21%]">
                        <Button
                          className="flex lg:h-[26px] xl:h-[33px] 2xl:h-[37px] 3xl:h-[44px] items-center justify-center ml-[4px] lg:w-[25px] xl:w-[32px] 2xl:w-[36px] 3xl:w-[43px]"
                          shape="icbCircleBorder20"
                          size="lgIcn"
                          variant="icbFillGray101"
                        >
                    ...
                    <Column className="items-center justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[100%]">
                      <Line className="bg-black_900_14 h-[1px] w-[100%]" />
                      <Grid className="lg:gap-[18px] xl:gap-[22px] 2xl:gap-[25px] 3xl:gap-[30px] grid grid-cols-4 lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[95%]">
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          ...
                          <Text className="albums" variant="body10">
                            {"<Photo Caption>"}
                          </Text>
                        </Column>
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_189X189.png"
                              className="Rectangle104"
                              alt="Rectangle103"
                            />
                          </Stack>
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_1.png"
                              className="Rectangle104"
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_2.png"
                              className="Rectangle104"
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle104_189X189.png"
                              className="Rectangle104"
                              alt="Rectangle104 One"
                            />
                          </Stack>
                          <Text className="albums" variant="body10">
                            {"<Photo Caption>"}
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_3.png"
                              className="Rectangle104"
                        ...
                        <Column
                          className="common-pointer justify-start rounded-radius15 w-[100%]"
                          onClick={handleNavigate53}
                        >
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_4.png"
                              className="Rectangle104"
                              alt="Rectangle103 Four"
                            />
                          </Stack>
                          <Text className="albums" variant="body10">
                            {"<Photo Caption>"}
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_5.png"
                              className="Rectangle104"
                              alt="Rectangle103 Five"
                            />
                          </Stack>
                          <Text className="albums" variant="body10">
                            {"<Photo Caption>"}
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle104_1.png"
                              className="Rectangle104"
                              alt="Rectangle104 Two"
                            />
                          </Stack>
                          <Text className="albums" variant="body10">
                            {"<Photo Caption>"}
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_6.png"
                              className="Rectangle104"
                              alt="Rectangle103 Eight"
                            />
                          </Stack>
                          <Text className="albums" variant="body10">
                            {"<Photo Caption>"}
                      ...
                      <Stack className="lg:h-[29px] xl:h-[36px] 2xl:h-[41px] 3xl:h-[49px] lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[100%]">
                        <Line className="absolute bg-black_900_14 h-[1px] top-[0] w-[100%]" />
                        <Button
                          className="2xl:mr-[327px] 3xl:mr-[393px] absolute flex items-center justify-center lg:mr-[232px] right-[39%] text-center w-[17%] xl:mr-[291px]"
                          rightIcon={
                            <Img
                          ...
                          variant="FillWhiteA700"
                        >
                          <div className="bg-transparent capitalize font-medium right-[0] lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-gray_501">
                            Show More
                          </div>
                        </Button>
                      </Stack>
          ...
          <Column className="justify-start lg:mt-[18px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] w-[96%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_28.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileSocialSectionGalleryPhotosPage;
