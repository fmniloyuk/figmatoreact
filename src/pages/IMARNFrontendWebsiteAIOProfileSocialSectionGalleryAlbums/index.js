...
const IMARNFrontendWebsiteAIOProfileSocialSectionGalleryAlbumsPage = () => {
    ...
    <>
      <Column className="bg-white_A700 font-poppins justify-start mx-[auto] overflow-auto pt-[2px] w-[100%]">
        <Column className="items-center lg:pr-[29px] xl:pr-[36px] 2xl:pr-[40px] 3xl:pr-[49px] w-[100%]">
                ...
                <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                  <Row className="items-center justify-between w-[99%]">
                    <Column className="items-center w-[23%]">
                      ...
                      <Img
                        src="images/img_emailphonepay_10.svg"
          ...
          <Column className="items-center justify-start lg:mt-[27px] xl:mt-[33px] 2xl:mt-[38px] 3xl:mt-[45px] 3xl:pb-[1055px] lg:pb-[625px] xl:pb-[781px] 2xl:pb-[879px] w-[85%]">
            <Column className="items-center justify-start w-[100%]">
              ...
              <Row className="items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                <Column className="bg-white_A700 border border-black_900_0c border-solid justify-end py-[2px] rounded-radius15 w-[68%]">
                  <Row className="items-start lg:ml-[13px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] mr-[auto] lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] pb-[3px] w-[26%]">
                    ...
                    <Column className="justify-start lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] w-[18%]">
                      ...
                      <Text className="columnvideocamera_one" variant="body12">
                        Videos
                      </Text>
                    </Column>
                    <Column className="justify-start lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] w-[21%]">
                      ...
                      >
                        <Img
                          src="images/img_folder_38X38.svg"
                  ...
                  <Column className="items-center justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[100%]">
                    <Line className="bg-black_900_14 h-[1px] w-[100%]" />
                    <Column className="items-center justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] pb-[4px] rounded-radius15 w-[95%]">
                      <Grid className="lg:gap-[18px] xl:gap-[22px] 2xl:gap-[25px] 3xl:gap-[30px] grid grid-cols-4 w-[100%]">
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle104_2.png"
                          ...
                          <Text className="photosCounter" variant="body12">
                            10 Photos
                          </Text>
                        </Column>
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_7.png"
                              className="Rectangle104"
                              alt="Rectangle103"
                            />
                          </Stack>
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_9.png"
                              className="Rectangle104"
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_10.png"
                              className="Rectangle104"
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_11.png"
                              className="Rectangle104"
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_12.png"
                              className="Rectangle104"
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_13.png"
                              className="Rectangle104"
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_adv_250X300.png"
                              className="Rectangle104"
                              alt="Rectangle105"
                            />
                          </Stack>
                        ...
                        <Column className="justify-start rounded-radius15 w-[100%]">
                          <Stack className="bg-bluegray_101 border border-black_900_20 border-solid lg:h-[129px] xl:h-[161px] 2xl:h-[182px] 3xl:h-[218px] px-[1px] rounded-radius15 lg:w-[128px] xl:w-[160px] 2xl:w-[181px] 3xl:w-[217px]">
                            <Img
                              src="images/img_rectangle103_14.png"
                              className="Rectangle104"
                              alt="Rectangle103 Nine"
                            />
                          </Stack>
                          <Text className="ProfilePhotos" variant="body10">
                            {"<Album Name>"}
                    ...
                    <Column className="items-center justify-start lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] rounded-radius6 w-[100%]">
                      <Line className="bg-black_900_14 h-[1px] w-[100%]" />
                      <Button
        ...
        <Column className="items-end xl:mt-[101px] 2xl:mt-[114px] 3xl:mt-[137px] lg:mt-[81px] 2xl:pl-[104px] 3xl:pl-[125px] lg:pl-[74px] xl:pl-[93px] w-[100%]">
          <Column className="justify-start w-[100%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_30.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileSocialSectionGalleryAlbumsPage;
