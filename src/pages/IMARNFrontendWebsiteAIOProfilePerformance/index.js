...
const IMARNFrontendWebsiteAIOProfilePerformancePage = () => {
  ...
  return (
    <>
      <Column className="bg-white_A700 font-poppins items-center justify-start mx-[auto] overflow-auto pt-[2px] w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_17.svg"
          ...
          <Column className="items-center justify-start w-[100%]">
            <Column className="justify-start w-[100%]">
              <Row className="items-center ml-[1px] w-[63%]">
                ...
                <Button
                  className="capitalize font-medium ml-[2px] lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-center w-[20%]"
                  shape="CircleBorder12"
                  size="lg"
                  variant="GradientDeeporangeA400Pink900"
                >
            ...
            <Row className="bg-white_A700 border border-black_900_0c border-solid items-start justify-center lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius15 shadow-bs12 w-[67%]">
              <Column className="items-center justify-start lg:ml-[12px] xl:ml-[15px] 2xl:ml-[17px] 3xl:ml-[20px] w-[4%]">
                <Img
                  src="images/img_trendingup.svg"
                  className="calendar"
                  alt="trendingup"
                />
                <Text className="photosCounter" variant="body10">
                  Sales
                </Text>
              </Column>
              <Column className="items-center justify-start lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] my-[1px] w-[7%]">
                <Img
                  src="images/img_dollarsign.svg"
                  className="calendar"
                  alt="dollarsign"
                />
                <Text className="capitalize TitleatCompa" variant="body10">
                  Earnings
                </Text>
              </Column>
              <Column className="items-center justify-start lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] mt-[1px] w-[10%]">
                <Img
                  src="images/img_dollarsign.svg"
                  className="calendar"
                  alt="dollarsign One"
              ...
              <Column className="items-center justify-start lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] mt-[1px] w-[5%]">
                <Img
                  src="images/img_minimize_20X20.svg"
                  className="calendar"
                  alt="minimize One"
                />
                <Text className="points" variant="body10">
                  Points
                </Text>
              </Column>
              <Column className="items-center justify-start lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] my-[1px] w-[6%]">
                <Img
                ...
                />
                <Text
                  className="lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] column500k"
                  variant="body10"
                >
                  Ratings
                </Text>
              </Column>
              <Column className="items-center justify-start lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] mt-[1px] w-[4%]">
                <Img
                  src="images/img_thumbsup_1.svg"
                  className="calendar"
                  alt="thumbsup One"
                />
                <Text className="points" variant="body10">
              ...
              <Column className="items-center justify-start lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] mt-[1px] w-[6%]">
                <Img
              ...
              <Column className="items-center justify-start lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] lg:mr-[12px] xl:mr-[15px] 2xl:mr-[17px] 3xl:mr-[20px] mt-[1px] w-[11%]">
                <Img
                  src="images/img_cut_24X24.svg"
                  className="file_One1"
                  alt="cut"
                />
                <Text className="gallery" variant="body10">
                  Relationships
                </Text>
              </Column>
            </Row>
            <Row className="font-prompt items-start justify-between lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[100%]">
              <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-start lg:p-[19px] xl:p-[24px] 2xl:p-[27px] 3xl:p-[33px] rounded-radius15 w-[68%]">
                <List
                  className="gap-[0] min-h-[auto] mt-[3px] w-[100%]"
                  orientation="vertical"
                >
                  <Column className="items-center justify-start lg:my-[22px] xl:my-[27px] 2xl:my-[31px] 3xl:my-[37px] rounded-radius15 w-[100%]">
                    <Column className="justify-start w-[100%]">
                      <Text
                      ...
                      <Row className="items-center justify-between lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[100%]">
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          <Text className="price4" variant="body2">
                            $1.1K
                          </Text>
                          <Text
                            className="mb-[1px] StoresEarnings"
                            variant="body10"
                          >
                            Courses
                            <br />
                        ...
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mb-[2px] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] text-center text-white_A700 w-[36%]"
                            variant="body10"
                          >
                            Stores
                            <br />
                        ...
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] my-[3px] text-center text-white_A700 w-[50%]"
                            variant="body10"
                          >
                            Services Sales
                          </Text>
                        ...
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mb-[3px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[39%]"
                            variant="body10"
                          >
                            Events <br />
                            Sales
                      ...
                      <Row className="items-center lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[100%]">
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] my-[3px] text-center text-white_A700 w-[58%]"
                            variant="body10"
                          >
                            Webinars <br />
                            Sales
                        ...
                        <Column className="bg-blue_700 items-center lg:ml-[35px] xl:ml-[44px] 2xl:ml-[50px] 3xl:ml-[60px] lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          <Text className="price4" variant="body2">
                            $1.1K
                          </Text>
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] my-[3px] text-center text-white_A700 w-[85%]"
                            variant="body10"
                          >
                            Consultations Sales
                          </Text>
                        </Column>
                        <Column className="bg-green_700 items-center lg:ml-[183px] xl:ml-[229px] 2xl:ml-[258px] 3xl:ml-[309px] lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          <Text className="price4" variant="body2">
                            $6.8K
                          </Text>
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mb-[2px] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] text-center text-white_A700 w-[31%]"
                            variant="body10"
                          >
                            Total Sales
                          </Text>
                  ...
                  <Column className="items-center justify-start lg:my-[22px] xl:my-[27px] 2xl:my-[31px] 3xl:my-[37px] rounded-radius15 w-[100%]">
                    <Column className="justify-start w-[100%]">
                      ...
                      <Grid className="lg:gap-[35px] xl:gap-[44px] 2xl:gap-[50px] 3xl:gap-[60px] grid grid-cols-4 lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[100%]">
                        <Column className="bg-blue_700 items-center justify-end lg:p-[13px] xl:p-[16px] 2xl:p-[19px] 3xl:p-[22px] rounded-radius15 w-[100%]">
                          <Text className="price_One1" variant="body2">
                            $1K
                          </Text>
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] text-center text-white_A700 w-[49%]"
                            variant="body10"
                          >
                            Courses Earnings
                          </Text>
                        </Column>
                        <Column className="bg-blue_700 items-center justify-end lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius15 w-[100%]">
                          <Text className="price_One1" variant="body2">
                            $1K
                          </Text>
                          <Text className="StoresEarnings" variant="body10">
                            Stores Earnings
                          </Text>
                        </Column>
                        <Column className="bg-blue_700 items-center justify-end lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius15 w-[100%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[48%]"
                            variant="body10"
                          >
                            Services Earnings
                          </Text>
                        ...
                        <Column className="bg-blue_700 items-center justify-end lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius15 w-[100%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[54%]"
                            variant="body10"
                          >
                            Webinars <br />
                            Earnings
                        ...
                        <Column className="bg-blue_700 items-center justify-end lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius15 w-[100%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[79%]"
                            variant="body10"
                          >
                        ...
                        <Column className="bg-blue_700 items-center justify-end lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius15 w-[100%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] text-center text-white_A700 w-[73%]"
                            variant="body10"
                          >
                            Ambassador Earnings
                          </Text>
                        ...
                        <Column className="bg-blue_700 items-center justify-end lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius15 w-[100%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[70%]"
                            variant="body10"
                          >
                      ...
                      <Column className="bg-green_700 items-center justify-end lg:ml-[442px] xl:ml-[554px] 2xl:ml-[623px] 3xl:ml-[747px] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius15 w-[20%]">
                        <Text className="price_One1" variant="body2">
                          $10K
                        </Text>
                        <Text className="StoresEarnings" variant="body10">
                ...
                <Column className="items-center justify-start lg:mt-[55px] xl:mt-[69px] 2xl:mt-[78px] 3xl:mt-[93px] rounded-radius15 w-[100%]">
                  <Column className="justify-start w-[100%]">
                    <Text
                      className="capitalize text-black_900 w-[auto]"
                      variant="body2"
                    ...
                    <List
                      className="gap-[0] min-h-[auto] lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[100%]"
                      orientation="vertical"
                    >
                      <Row className="listrectangle109">
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] my-[2px] text-center text-white_A700 w-[80%]"
                            variant="body10"
                          >
                            Membership
                            <br />
                        ...
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text className="CoursesInvestm" variant="body10">
                            Courses Investment
                          </Text>
                        </Column>
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] my-[2px] text-center text-white_A700 w-[69%]"
                            variant="body10"
                          >
                            Services Investment
                          </Text>
                      ...
                      <Row className="listrectangle109">
                        ...
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] my-[2px] text-center text-white_A700 w-[77%]"
                            variant="body10"
                          >
                        ...
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] my-[2px] text-center text-white_A700 w-[85%]"
                            variant="body10"
                          >
                            Consultations Investments
                          </Text>
                        </Column>
                      </Row>
                    </List>
                    <Row className="items-center justify-between lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[100%]">
                      <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                        ...
                        <Text
                          className="capitalize font-bold font-poppins leading-[140.00%] mb-[1px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[66%]"
                          variant="body10"
                        >
                          Sponsoring Fees
                        </Text>
                      </Column>
                      <Column className="bg-green_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                        <Text className="price4" variant="body2">
                          $5.5K
                        </Text>
                        <Text
                          className="capitalize font-bold font-poppins leading-[140.00%] mb-[2px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[77%]"
                          variant="body10"
                        >
                          Total Investments
                        </Text>
                ...
                <Column className="items-center justify-start lg:mt-[41px] xl:mt-[52px] 2xl:mt-[59px] 3xl:mt-[70px] w-[100%]">
                  <Column className="justify-start w-[100%]">
                    ...
                    >
                      <Row className="listrectangle109">
                        <Column className="items-center w-[20%]">
                          <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                            <Row className="font-prompt items-center w-[47%]">
                              <Img
                                src="images/img_calculator_20X20.svg"
                                className="calendar"
                                alt="calculator"
                              />
                              <Text
                                className="capitalize ml-[3px] text-white_A700 w-[auto]"
                                variant="body2"
                              >
                                75
                              </Text>
                            ...
                            <Text
                              className="capitalize font-bold font-poppins leading-[140.00%] mb-[2px] lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] text-center text-white_A700 w-[56%]"
                              variant="body10"
                            >
                              General
                              <br />
                        ...
                        <Column className="items-center w-[20%]">
                          <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                            <Row className="font-prompt items-center w-[58%]">
                              <Img
                                src="images/img_calculator_20X20.svg"
                                className="calendar"
                                alt="calculator One"
                            ...
                            <Text
                              className="columncalculator_one"
                              variant="body10"
                            >
                              V-Guide Activities{" "}
                            </Text>
                        ...
                        <Column className="items-center w-[20%]">
                          <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                            <Row className="font-prompt items-center w-[64%]">
                              <Img
                                src="images/img_calculator_20X20.svg"
                                className="calendar"
                                alt="calculator Two"
                            ...
                            <Text
                              className="columncalculator_two"
                              variant="body10"
                            >
                              V-Blog Activities{" "}
                            </Text>
                        ...
                        <Column className="items-center w-[20%]">
                          <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                            <Row className="font-prompt items-center w-[66%]">
                              <Img
                                src="images/img_calculator_20X20.svg"
                                className="calendar"
                      ...
                      <Row className="listrectangle109">
                        <Column className="items-center w-[20%]">
                          <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                            <Row className="font-prompt items-center w-[68%]">
                              <Img
                                src="images/img_calculator_20X20.svg"
                                className="calendar"
                                alt="calculator One"
                        ...
                        <Column className="items-center w-[20%]">
                          <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                            <Row className="font-prompt items-center w-[65%]">
                              <Img
                                src="images/img_calculator_20X20.svg"
                                className="calendar"
                            ...
                            <Text
                              className="columncalculator_one_one"
                              variant="body10"
                            >
                              V-College Activities{" "}
                            </Text>
                          </Column>
                        </Column>
                        <Column className="items-center w-[20%]">
                          <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                            <Row className="font-prompt items-center w-[62%]">
                              <Img
                                src="images/img_calculator_20X20.svg"
                                className="calendar"
                                alt="calculator Two One"
                              />
                              <Text
                                className="rowcalculator_two"
                                variant="body2"
                            ...
                            <Text
                              className="capitalize font-bold font-poppins leading-[140.00%] mb-[2px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[58%]"
                              variant="body10"
                            >
                              V-Market Activities{" "}
                            </Text>
                        ...
                        <Column className="items-center w-[20%]">
                          <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                            <Stack className="font-prompt lg:h-[21px] xl:h-[26px] 2xl:h-[29px] 3xl:h-[35px] w-[58%]">
                              <Text
                                className="absolute capitalize right-[0] text-white_A700 w-[auto]"
                                variant="body2"
                              >
                                150
                              </Text>
                              <Img
                                src="images/img_calculator_20X20.svg"
                                className="absolute inset-y-[0] left-[0] my-[auto] calendar"
                                alt="calculator Three One"
                              />
                            </Stack>
                            <Text
                              className="columncalculator_two"
                    ...
                    <Row className="items-center justify-between lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[100%]">
                      <List
                        className="lg:gap-[35px] xl:gap-[44px] 2xl:gap-[50px] 3xl:gap-[60px] grid grid-cols-2 min-h-[auto] w-[47%]"
                        orientation="horizontal"
                      >
                        <Column className="items-center justify-start w-[100%]">
                          <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                            <Row className="font-prompt items-center w-[46%]">
                              <Img
                                src="images/img_calculator_20X20.svg"
                                className="calendar"
                                alt="calculator Two"
                        ...
                        <Column className="items-center justify-start w-[100%]">
                          <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                            ...
                            <Text
                              className="capitalize font-bold font-poppins leading-[140.00%] my-[2px] text-center text-white_A700 w-[73%]"
                              variant="body10"
                            >
                              V-Webinars Activities
                            </Text>
                          </Column>
                        </Column>
                      </List>
                      <Column className="bg-green_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                        ...
                        <Text
                          className="capitalize font-bold font-poppins leading-[140.00%] mb-[2px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[36%]"
                          variant="body10"
                        >
                          Total <br />
                          Points
                ...
                <List
                  className="gap-[0] min-h-[auto] lg:mt-[44px] xl:mt-[55px] 2xl:mt-[61px] 3xl:mt-[74px] w-[100%]"
                  orientation="vertical"
                >
                  <Column className="items-center justify-start lg:my-[21px] xl:my-[26px] 2xl:my-[29px] 3xl:my-[35px] rounded-radius15 w-[100%]">
                    <Column className="justify-start w-[100%]">
                      <Text
                        className="capitalize text-black_900 w-[auto]"
                        variant="body2"
                      ...
                      <Row className="items-center justify-between lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[100%]">
                        <Column className="bg-blue_700 items-center lg:p-[16px] xl:p-[20px] 2xl:p-[22px] 3xl:p-[27px] rounded-radius15 w-[20%]">
                          <Text className="test_5100" variant="body2">
                            5(100)
                          </Text>
                          <Text className="ProfileActivit" variant="body10">
                            Profile
                            <br />
                            Activities
                          </Text>
                        ...
                        <Column className="bg-blue_700 items-center lg:p-[16px] xl:p-[20px] 2xl:p-[22px] 3xl:p-[27px] rounded-radius15 w-[20%]">
                          ...
                          <Text className="VBlogActiviti" variant="body10">
                            V-Blog Activities
                          </Text>
                        </Column>
                        <Column className="bg-blue_700 items-center lg:p-[16px] xl:p-[20px] 2xl:p-[22px] 3xl:p-[27px] rounded-radius15 w-[20%]">
                      ...
                      <Row className="items-center justify-between lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[100%]">
                        ...
                        <Column className="bg-blue_700 items-center lg:p-[16px] xl:p-[20px] 2xl:p-[22px] 3xl:p-[27px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mt-[3px] text-center text-white_A700 w-[62%]"
                            variant="body10"
                          >
                            V-College Activities
                          </Text>
                        ...
                        <Column className="bg-blue_700 items-center lg:p-[16px] xl:p-[20px] 2xl:p-[22px] 3xl:p-[27px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mt-[3px] text-center text-white_A700 w-[60%]"
                            variant="body10"
                          >
                            V-Market Activities
                          </Text>
                      ...
                      <Row className="items-center lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[100%]">
                        ...
                        <Column className="bg-blue_700 items-center lg:ml-[35px] xl:ml-[44px] 2xl:ml-[50px] 3xl:ml-[60px] lg:p-[16px] xl:p-[20px] 2xl:p-[22px] 3xl:p-[27px] rounded-radius15 w-[20%]">
                          <Text className="test_5100" variant="body2">
                            5(300)
                          </Text>
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mt-[1px] text-center text-white_A700 w-[75%]"
                            variant="body10"
                          >
                            V-Webinars Activities
                          </Text>
                        </Column>
                        <Column className="bg-green_700 items-center lg:ml-[184px] xl:ml-[230px] 2xl:ml-[259px] 3xl:ml-[311px] lg:p-[13px] xl:p-[16px] 2xl:p-[19px] 3xl:p-[22px] rounded-radius15 w-[20%]">
                          <Text
                            className="lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] price4"
                            variant="body2"
                          >
                            5(1.2K)
                          </Text>
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mt-[3px] text-center text-white_A700 w-[44%]"
                            variant="body10"
                          >
                            Total Ratings
                          </Text>
                  ...
                  <Column className="items-center justify-start lg:my-[21px] xl:my-[26px] 2xl:my-[29px] 3xl:my-[35px] rounded-radius15 w-[100%]">
                    <Column className="justify-start w-[100%]">
                      ...
                      <Row className="items-center justify-between lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[99%]">
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          <Text className="price4" variant="body2">
                            1K
                          </Text>
                          <Text className="ProfileActivit_One" variant="body10">
                            Profile
                            <br />
                            Activities
                          </Text>
                        ...
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text className="VBlogActiviti_One" variant="body10">
                            V-Blog Activities
                          </Text>
                        </Column>
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                      ...
                      <Row className="items-center justify-between lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[100%]">
                        ...
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mb-[2px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[63%]"
                            variant="body10"
                          >
                            V-College Activities
                          </Text>
                      ...
                      <Row className="items-center lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[100%]">
                        ...
                        <Column className="bg-blue_700 items-center lg:ml-[39px] xl:ml-[49px] 2xl:ml-[55px] 3xl:ml-[66px] lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[19%]">
                          <Text className="price4" variant="body2">
                            200
                          </Text>
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] my-[2px] text-center text-white_A700 w-[79%]"
                            variant="body10"
                          >
                            V-Webinars Activities
                          </Text>
                        </Column>
                        <Column className="bg-green_700 items-center lg:ml-[190px] xl:ml-[238px] 2xl:ml-[268px] 3xl:ml-[322px] lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          <Text className="price4" variant="body2">
                            7.2K
                          </Text>
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mb-[2px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[32%]"
                            variant="body10"
                          >
                            Total <br />
                            Likes
                    ...
                    <Column className="justify-start w-[100%]">
                      ...
                      <Row className="items-center justify-between lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[99%]">
                        <Column className="bg-blue_700 items-center lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] my-[2px] text-center text-white_A700 w-[42%]"
                            variant="body10"
                          >
                            Profile Shares
                          </Text>
                      ...
                      <Row className="items-center lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[100%]">
                        ...
                        <Column className="bg-green_700 items-center lg:ml-[190px] xl:ml-[238px] 2xl:ml-[268px] 3xl:ml-[322px] lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[20%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mb-[2px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[41%]"
                            variant="body10"
                          >
                            Total <br />
                            Shares
                ...
                <Column className="items-center justify-start lg:mb-[31px] xl:mb-[38px] 2xl:mb-[43px] 3xl:mb-[52px] lg:mt-[44px] xl:mt-[55px] 2xl:mt-[61px] 3xl:mt-[74px] rounded-radius15 w-[100%]">
                  <Column className="items-end justify-start w-[100%]">
                    <Column className="justify-start w-[100%]">
                      ...
                      <List
                        className="lg:gap-[40px] xl:gap-[50px] 2xl:gap-[57px] 3xl:gap-[68px] grid grid-cols-4 min-h-[auto] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[100%]"
                        orientation="horizontal"
                      >
                        <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                          <Text className="price4" variant="body2">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mb-[1px] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] text-center text-white_A700 w-[78%]"
                            variant="body10"
                          >
                            Total Connections
                          </Text>
                        ...
                        <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mb-[1px] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] text-center text-white_A700 w-[57%]"
                            variant="body10"
                          >
                            Total
                            <br />
                        ...
                        <Column className="bg-blue_700 items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[20px] 3xl:p-[25px] rounded-radius15 w-[100%]">
                          ...
                          <Text
                            className="capitalize font-bold font-poppins leading-[140.00%] mb-[1px] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] text-center text-white_A700 w-[67%]"
                            variant="body10"
                          >
                            Total
                            <br />
                    ...
                    <Column className="bg-green_700 items-center justify-end lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] lg:p-[13px] xl:p-[16px] 2xl:p-[19px] 3xl:p-[22px] rounded-radius15 w-[20%]">
                      <Text className="price_One1" variant="body2">
                        16.8K
                      </Text>
                      <Text
                        className="capitalize font-bold font-poppins leading-[140.00%] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] text-center text-white_A700 w-[86%]"
                        variant="body10"
                      >
                        Total Relationships
                      </Text>
        ...
        <Column className="items-end lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] 2xl:pl-[104px] 3xl:pl-[125px] lg:pl-[74px] xl:pl-[93px] w-[100%]">
          <Column className="justify-start w-[100%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_37.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfilePerformancePage;
