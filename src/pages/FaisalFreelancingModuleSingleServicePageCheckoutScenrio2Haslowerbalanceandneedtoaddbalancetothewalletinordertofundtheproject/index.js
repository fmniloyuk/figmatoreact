...
const FaisalFreelancingModuleSingleServicePageCheckoutScenrio2HaslowerbalanceandneedtoaddbalancetothewalletinordertofundtheprojectPage =
  () => {
    return (
      <>
          ...
          <Column className="items-center justify-start w-[100%]">
            ...
            <Column className="items-center justify-start lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] w-[100%]">
              <Row className="items-start w-[85%]">
                <Column className="items-center justify-start pt-[4px] w-[66%]">
                  <Column className="items-center justify-start w-[100%]">
                    <Column className="justify-start w-[100%]">
                      <Text className="columntitleofthec" variant="body7">
                        Service Summary
                      </Text>
                      <Row className="font-poppins items-center justify-between lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[100%]">
                        <Row className="items-center justify-between w-[61%]">
                          <Stack className="bg-bluegray_101 lg:h-[55px] xl:h-[68px] 2xl:h-[77px] 3xl:h-[92px] lg:pr-[3px] 2xl:pr-[4px] xl:pr-[4px] 3xl:pr-[5px] rounded-radius10 w-[24%]">
                            <Img
                          ...
                          <Column className="w-[74%]">
                            <Text
                              ...
                              variant="body10"
                            >
                              You will get a modern political campaign LOGO
                              design
                            </Text>
                            <Row className="items-center lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] xl:pr-[11px] 2xl:pr-[13px] 3xl:pr-[16px] lg:pr-[9px] w-[70%]">
                              <Row className="items-center justify-evenly w-[11%]">
                                <Img
                              ...
                              <Row className="items-start justify-center lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] w-[21%]">
                                <Img
                              ...
                              <Column className="items-center lg:ml-[13px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] w-[16%]">
                              ...
                              <Column className="items-center lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[9px] py-[1px] w-[11%]">
                        ...
                        <Row className="items-end justify-between w-[27%]">
                          <Text
                            className="font-poppins xl:mb-[11px] 2xl:mb-[12px] 3xl:mb-[14px] lg:mb-[8px] lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] XAxis"
                            variant="body10"
                          >
                            Qty
                          </Text>
                          <SelectBox
                            className="capitalize font-medium font-poppins xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px] lg:text-[9px] text-black_900 w-[40%]"
                            ...
                            indicator={
                              <Img
                                ...
                                className="lg:w-[8px] lg:h-[9px] lg:mr-[6px] xl:w-[10px] xl:h-[11px] xl:mr-[8px] 2xl:w-[11px] 2xl:h-[12px] 2xl:mr-[9px] 3xl:w-[13px] 3xl:h-[14px] 3xl:mr-[11px]"
                                alt="arrow_down"
                              />
                            }
                          ...
                          ></SelectBox>
                          <Text
                            className="lg:my-[4px] xl:my-[5px] 2xl:my-[6px] 3xl:my-[8px] rowcoverletter_one"
                            variant="body2"
                          >
                            +$120
                          </Text>
                  ...
                  <Line className="bg-bluegray_102 h-[1px] lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] rounded-radius05 w-[100%]" />
                ...
                <Column className="items-center justify-start lg:ml-[19px] xl:ml-[24px] 2xl:ml-[27px] 3xl:ml-[33px] w-[32%]">
                  <Column className="items-center justify-start 3xl:pb-[1173px] lg:pb-[694px] xl:pb-[869px] 2xl:pb-[977px] w-[100%]">
                    <Column className="bg-white_A700 border border-bluegray_102 border-solid justify-end lg:p-[11px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[19px] rounded-radius15 w-[100%]">
                      <Text className="plans" variant="body7">
                        Price Summary
                      </Text>
                      <Column className="font-poppins justify-start lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] pt-[4px] w-[99%]">
                        <Row className="items-center w-[94%]">
                          <Text className="NumberofRevis_One" variant="body9">
                            Subtotal
                          </Text>
                          <Text
                            className="lg:ml-[151px] xl:ml-[189px] 2xl:ml-[213px] 3xl:ml-[256px] mt-[1px] Amazon"
                            variant="body9"
                          >
                            $120.00
                          </Text>
                        </Row>
                        <Row className="items-center lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] w-[94%]">
                          <Text className="NumberofRevis_One" variant="body9">
                            Service Fee
                          </Text>
                          <Text
                            className="lg:ml-[143px] xl:ml-[179px] 2xl:ml-[202px] 3xl:ml-[242px] mt-[1px] Amazon"
                            variant="body9"
                          >
                            $12.00
                          </Text>
                        </Row>
                        <Row className="items-start lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] w-[94%]">
                          <Text className="Amazon" variant="body9">
                            VAT(5%)
                          </Text>
                          <Text
                            className="lg:ml-[161px] xl:ml-[202px] 2xl:ml-[227px] 3xl:ml-[273px] mt-[1px] Amazon"
                            variant="body9"
                          >
                            $6.00
                          </Text>
                        </Row>
                        <Line className="bg-bluegray_102 h-[1px] xl:mt-[11px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] rounded-radius05 w-[99%]" />
                        <Row className="items-center xl:mt-[11px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] w-[94%]">
                          <Text className="Total" variant="body9">
                            Total
                          </Text>
                          <Text className="price_Eleven" variant="body9">
                            $138.00
                          </Text>
                        </Row>
                        <Line className="bg-bluegray_102 h-[1px] xl:mt-[11px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] rounded-radius05 w-[99%]" />
                        <Row className="items-center xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] w-[94%]">
                          <Text className="NumberofRevis_One" variant="body9">
                            Available Wallet Balance
                          </Text>
                          <Text
                            className="font-medium 3xl:ml-[109px] lg:ml-[65px] xl:ml-[81px] 2xl:ml-[91px] mt-[1px] text-red_A701 w-[auto]"
                            variant="body9"
                          >
                            $45.50
                          </Text>
                        </Row>
                        <Row className="items-end justify-between xl:mt-[11px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] rounded-radius12 w-[100%]">
                          <Text
                            className="mb-[3px] lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] extraactionso"
                            variant="body12"
                          >
                            Top up your wallet to fund the Order
                          </Text>
                          <Button
                            className="capitalize font-semibold xl:text-[10px] 2xl:text-[11px] 3xl:text-[13px] lg:text-[8px] text-center w-[28%]"
                      ...
                      <Button
                        className="capitalize font-medium mb-[1px] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px] lg:text-[9px] text-center text-white_A700 w-[100%]"
                        shape="CircleBorder12"
                        size="xl"
              ...
              <Footer2 className="font-poppins lg:mt-[156px] xl:mt-[195px] 2xl:mt-[220px] 3xl:mt-[264px] w-[100%]" />
            </Column>
          </Column>
        </Column>
      </>
...
export default FaisalFreelancingModuleSingleServicePageCheckoutScenrio2HaslowerbalanceandneedtoaddbalancetothewalletinordertofundtheprojectPage;
