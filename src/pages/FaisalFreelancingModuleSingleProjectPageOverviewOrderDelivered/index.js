...
const FaisalFreelancingModuleSingleProjectPageOverviewOrderDeliveredPage =
  () => {
              ...
              <Row className="items-start w-[85%]">
                <Column className="items-center justify-start w-[66%]">
                  ...
                  <Column className="bg-white_A700 border border-bluegray_102 border-solid justify-start lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] lg:pr-[12px] xl:pr-[15px] 2xl:pr-[17px] 3xl:pr-[20px] lg:py-[12px] xl:py-[15px] 2xl:py-[17px] 3xl:py-[20px] rounded-radius15 w-[100%]">
                    ...
                    <Stack className="lg:h-[1165px] xl:h-[1458px] 2xl:h-[1640px] 3xl:h-[1967px] xl:mb-[10px] 2xl:mb-[11px] 3xl:mb-[13px] lg:mb-[8px] lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[100%]">
                          ...
                          <Column className="justify-start w-[98%]">
                            ...
                            <Row className="items-center justify-between lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[100%]">
                              ...
                              <Row className="items-start justify-between pt-[4px] w-[92%]">
                                <Row className="items-start justify-between w-[50%]">
                                  <Text
                          ...
                          <Column className="justify-start w-[98%]">
                            ...
                            <Row className="items-start justify-between xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[100%]">
                              ...
                              <Column className="justify-start w-[92%]">
                                ...
                                <Column className="bg-gray_100 border border-black_900_0c border-solid items-center justify-start lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius10 w-[29%]">
                                  <Row className="items-start w-[95%]">
                                    <Line className="bg-gray_501 lg:h-[41px] xl:h-[51px] 2xl:h-[58px] 3xl:h-[69px] w-[3px]" />
                                    <Row className="items-start justify-between lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[8px] w-[95%]">
                                      <Button
                                        className="flex lg:h-[34px] xl:h-[43px] 2xl:h-[48px] 3xl:h-[58px] items-center justify-center rounded-radius50 lg:w-[33px] xl:w-[42px] 2xl:w-[47px] 3xl:w-[57px]"
                                        size="xlIcn"
                                      ...
                                      <Column className="justify-start mt-[2px] w-[66%]">
                                        <Text
                                          className="font-medium text-black_900 w-[auto]"
                                          variant="body10"
                                        >
                                        ...
                                        <Text
                                          className="font-medium 3xl:mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] text-gray_501 w-[auto]"
                                          variant="body12"
                                        >
                                          {"<File Name>(2 MB)"}
                                        </Text>
                            ...
                            <Row className="items-start justify-between xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] w-[100%]">
                              ...
                              <Column className="justify-start w-[92%]">
                                <Column className="justify-start w-[100%]">
                                  <Row className="items-start justify-between w-[100%]">
                                    <Row className="items-start justify-between mt-[4px] w-[52%]">
                                      <Text
                                        className="font-semibold text-blue_700 w-[auto]"
                                        variant="body10"
                                      >
                                ...
                                <Column className="bg-gray_100 border border-black_900_0c border-solid items-center justify-start lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius10 w-[87%]">
                                  <Row className="items-center w-[98%]">
                                    <Line className="bg-gray_501 xl:h-[117px] 2xl:h-[132px] 3xl:h-[158px] lg:h-[94px] w-[3px]" />
                                    <Column className="lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[8px] pt-[2px] w-[98%]">
                                      ...
                                      <List
                                        className="lg:gap-[10px] xl:gap-[12px] 2xl:gap-[14px] 3xl:gap-[17px] grid grid-cols-4 min-h-[auto] 3xl:mt-[11px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] w-[100%]"
                                        orientation="horizontal"
                                      >
                                        <Column className="justify-start w-[100%]">
                                          <Img
                                            src="images/img_group543.png"
                                            className="RectangleSeven3"
                                            alt="RectangleSeven"
                                          />
                                          <Row className="items-start justify-between lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] w-[100%]">
                                            <Text
                                              className="font-medium text-gray_501 w-[auto]"
                                              variant="body12"
                                            >
                                              {"<File Name>(2 MB)"}
                                            </Text>
                        ...
                        <Row className="items-start justify-evenly lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                          ...
                          <Column className="justify-start w-[98%]">
                            <Row className="items-center w-[48%]">
                              ...
                              <Row className="items-start justify-between lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] w-[83%]">
                                <Text className="commentbox" variant="body10">
                            ...
                            <Img
                              ...
                              alt="line Four"
                            />
                            <Row className="items-start lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[81%]">
                              <Button
                                className="flex lg:h-[34px] xl:h-[43px] 2xl:h-[48px] 3xl:h-[58px] items-center justify-center rounded-radius50 lg:w-[33px] xl:w-[42px] 2xl:w-[47px] 3xl:w-[57px]"
                                size="lgIcn"
                                variant="icbOutlineBlack900201_2"
                              >
                                <Img
                                  src="images/img_star_50X50.svg"
                                  className="flex items-center justify-center lg:h-[17px] xl:h-[21px] 2xl:h-[23px] 3xl:h-[28px]"
                                  alt="star"
                                />
                              </Button>
                              <Column className="justify-start lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] pt-[2px] w-[90%]">
                                <Row className="items-start w-[50%]">
                                  <Text
                                    className="font-semibold text-black_900 w-[auto]"
                                    variant="body10"
                                  >
                                    You left 5-star review.
                                  </Text>
                                  <Text className="time_Five1" variant="body12">
                                    12-Nov-2022 5:35 PM
                                  </Text>
                                </Row>
                                <Column className="bg-gray_100 border border-black_900_0c border-solid items-center justify-start xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius10 w-[100%]">
                                  <Row className="items-start justify-between w-[98%]">
                                    ...
                                    <Column className="justify-start w-[89%]">
                                      <Column className="justify-start w-[55%]">
                                        <Row className="items-start w-[48%]">
                                          <Text
                                            className="rowme"
                                            variant="body10"
                                          >
                                          ...
                                          <Img
                                            src="images/img_starstarstar.svg"
                                            className="lg:h-[10px] xl:h-[12px] 2xl:h-[14px] 3xl:h-[17px] mb-[3px] lg:ml-[3px] 2xl:ml-[4px] xl:ml-[4px] 3xl:ml-[5px] w-[76%]"
                                            alt="starstarstar"
                                          />
                                        </Row>
                                        <Text
                                        ...
                                        >
                                          {
                                            "<Message for <Seller Name>’s Service>"
                                          }
                                        </Text>
                                      </Column>
                                      <Line className="bg-black_900_20 h-[1px] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[100%]" />
                                      <Row className="items-start lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] w-[69%]">
                                        <Text
                                          className="rowcommunicationw"
                                          variant="body10"
                                        >
                                          Communication with Seller
                                        </Text>
                                        <Img
                                          src="images/img_starstarstar_14X100.svg"
                                          className="lg:h-[10px] xl:h-[12px] 2xl:h-[14px] 3xl:h-[17px] lg:ml-[33px] xl:ml-[42px] 2xl:ml-[47px] 3xl:ml-[57px] mt-[1px] w-[29%]"
                                          alt="starstarstar One"
                                        />
                                      </Row>
                                      <Row className="items-start lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[69%]">
                                        <Text
                                          className="rowcommunicationw"
                                          variant="body10"
                                        >
                                        ...
                                        <Img
                                          src="images/img_starstarstar_14X100.svg"
                                          className="lg:h-[10px] xl:h-[12px] 2xl:h-[14px] 3xl:h-[17px] 3xl:ml-[100px] lg:ml-[59px] xl:ml-[74px] 2xl:ml-[83px] mt-[1px] w-[29%]"
                                          alt="starstarstar Two"
                                        />
                                      </Row>
                                      <Row className="items-start lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] w-[69%]">
                                        <Text
                                          className="rowbuyagainorre"
                                          variant="body10"
                                        >
                                        ...
                                        <Img
                                          src="images/img_starstarstar_14X100.svg"
                                          className="lg:h-[10px] xl:h-[12px] 2xl:h-[14px] 3xl:h-[17px] lg:ml-[40px] xl:ml-[50px] 2xl:ml-[57px] 3xl:ml-[68px] w-[29%]"
                                          alt="starstarstar Three"
                                        />
                                      </Row>
                                    </Column>
                                  </Row>
                            ...
                            <Img
                              ...
                              alt="line Five"
                            />
                            <Row className="items-start lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[56%]">
                              <Button
                                className="flex lg:h-[34px] xl:h-[43px] 2xl:h-[48px] 3xl:h-[58px] items-center justify-center rounded-radius50 lg:w-[33px] xl:w-[42px] 2xl:w-[47px] 3xl:w-[57px]"
                                size="lgIcn"
                                variant="icbOutlineBlack900201_2"
                              ...
                              <Column className="justify-start lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] pt-[2px] w-[86%]">
                                <Row className="items-start w-[95%]">
                                  <Text
                                    className="font-semibold text-black_900 w-[auto]"
                                    variant="body10"
                                  >
                                    {"<Seller Name> left 5-star review."}
                                  </Text>
                                  <Text className="time_Five1" variant="body12">
                                    12-Nov-2022 5:35 PM
                                  </Text>
                                ...
                                <Column className="bg-gray_100 border border-black_900_0c border-solid items-center justify-start xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius10 w-[100%]">
                                  <Row className="items-start justify-between w-[97%]">
                                    ...
                                    <Column className="justify-start w-[83%]">
                                      <Row className="items-start w-[71%]">
                                        <Text
                                          className="rowsellername"
                                          variant="body10"
                                        >
                                          {"<Seller Name>:"}
                                        </Text>
                                        <Img
                                          src="images/img_starstarstar.svg"
                                          className="lg:h-[10px] xl:h-[12px] 2xl:h-[14px] 3xl:h-[17px] mb-[2px] lg:ml-[3px] 2xl:ml-[4px] xl:ml-[4px] 3xl:ml-[5px] w-[47%]"
                                          alt="starstarstar Four"
                                        />
                                      </Row>
                                      <Text
                                        className="columnme"
                                        variant="body10"
                                      >
                                        <span className="text-gray_501 font-poppins lg:text-[9px] xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px]">
                                          {"<Feedback message from "}
                                        </span>
                                        <span className="text-blue_700 font-poppins font-bold lg:text-[9px] xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px]">
                                          {"<Seller Name>"}
                                        </span>
                                        <span className="text-gray_501 font-poppins lg:text-[9px] xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px]">
                                          {">"}
...
export default FaisalFreelancingModuleSingleProjectPageOverviewOrderDeliveredPage;
