...
const IMARNFrontendWebsiteAIOProfileSocialSectionConnectionsPage = () => {
    ...
    <>
      <Column className="bg-white_A700 font-prompt items-center justify-start mx-[auto] pt-[2px] w-[100%]">
        ...
        <Column className="font-poppins items-center justify-start overflow-auto w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_11.svg"
          ...
          <Column className="items-center justify-start lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[85%]">
            <Column className="items-center justify-start w-[100%]">
              ...
              <Row className="items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-start lg:py-[11px] xl:py-[14px] 2xl:py-[16px] 3xl:py-[19px] rounded-radius15 w-[68%]">
                  <Column className="items-center justify-start mb-[3px] w-[100%]">
                    <Column className="items-center justify-start w-[95%]">
                      <Row className="items-start justify-between w-[100%]">
                        <Row className="items-center justify-between mt-[3px] w-[29%]">
                          <Button
                            className="capitalize font-semibold lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-center w-[17%]"
                            size="sm"
                            variant="OutlineBlue7001_2"
                          >
                            All
                          </Button>
                          <Column className="items-center p-[3px] w-[37%]">
                            <Text className="navitem" variant="body9">
                              Personal
                            </Text>
                          </Column>
                          <Column className="items-center p-[2px] w-[38%]">
                            <Text className="navitem1" variant="body9">
                              Business
                            </Text>
                          </Column>
                        </Row>
                        <Row className="items-center rounded-radius4 w-[23%]">
                          <Button
                      ...
                      <Grid className="lg:gap-[13px] xl:gap-[16px] 2xl:gap-[19px] 3xl:gap-[22px] grid grid-cols-2 3xl:mt-[1191px] lg:mt-[705px] xl:mt-[882px] 2xl:mt-[993px] w-[100%]">
                    ...
                    <Column className="justify-start lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] rounded-radius6 w-[100%]">
                      <Line className="bg-black_900_14 h-[1px] w-[100%]" />
                      <Button
                ...
                <Stack className="lg:h-[584px] xl:h-[730px] 2xl:h-[821px] 3xl:h-[985px] w-[29%]">
                  <Column className="absolute bg-white_A700 border border-black_900_20 border-solid justify-start xl:p-[11px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] rounded-radius15 top-[0] w-[100%]">
                  ...
                  <Slider
                    ...
                    centerMode
                    ref={sliderRef}
                    className="absolute bottom-[0] font-prompt left-[0] w-[100%]"
                    items={[...Array(15)].map(() => (
                      <React.Fragment key={Math.random()}>
                        <Column className="font-poppins pages">
                          <Column
                            className="bg-cover bg-repeat items-center justify-start rounded-bl-[0] rounded-br-[0] rounded-tl-[15px] rounded-tr-[15px] w-[100%]"
                            style={{
                              backgroundImage: "url('images/img_image_2.png')",
          ...
          <Column className="justify-start lg:mt-[33px] xl:mt-[42px] 2xl:mt-[47px] 3xl:mt-[57px] w-[96%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_31.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileSocialSectionConnectionsPage;
