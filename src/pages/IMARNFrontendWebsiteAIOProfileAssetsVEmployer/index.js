...
const IMARNFrontendWebsiteAIOProfileAssetsVEmployerPage = () => {
  ...
  return (
    <>
      <Column className="bg-white_A700 font-poppins items-center justify-start mx-[auto] overflow-auto pt-[2px] w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_19.svg"
        ...
        <Slider
          ...
          items={[...Array(6)].map(() => (
            <React.Fragment key={Math.random()}>
              <Column className="font-poppins items-center justify-start lg:pb-[163px] xl:pb-[205px] 2xl:pb-[230px] 3xl:pb-[276px] w-[100%]">
                  ...
                  <Row className="font-prompt items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                    <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-end lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius15 w-[68%]">
                      <Row className="items-center justify-between 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[9px] w-[100%]">
                        ...
                        <List
                          className="lg:gap-[31px] xl:gap-[39px] 2xl:gap-[44px] 3xl:gap-[53px] grid grid-cols-3 min-h-[auto] w-[74%]"
                          orientation="horizontal"
                        >
                          <Column className="listfour">
                            <Text
                          ...
                          <Column className="listfour">
                            <Text
                              className="flex items-center TwoHundredThirtyThree"
                              variant="body2"
                            >
                              12
                            </Text>
                      ...
                      <List
                        className="gap-[0] mb-[1px] min-h-[auto] lg:mt-[32px] xl:mt-[40px] 2xl:mt-[45px] 3xl:mt-[54px] w-[100%]"
                        orientation="vertical"
                      >
                        <Column className="listvjobsvaccanci">
                          <Column className="items-center justify-start w-[100%]">
                            <Row className="items-start justify-between w-[100%]">
                              <Text className="albums" variant="body5">
                                V-Jobs Vaccancies
                              </Text>
                              <Row className="font-poppins items-center lg:mb-[5px] xl:mb-[6px] 2xl:mb-[7px] 3xl:mb-[9px] rounded-radius4 w-[24%]">
                                <Button
                            ...
                            <Column className="font-poppins items-center justify-start xl:mt-[11px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] w-[100%]">
                              <Column className="justify-start w-[100%]">
                        ...
                        <Column className="listvjobsvaccanci">
                          <Column className="justify-start w-[100%]">
                            <Row className="font-prompt items-end justify-between w-[100%]">
                              ...
                              <Row className="font-poppins items-center mb-[1px] rounded-radius4 w-[24%]">
                                <Button
                                  className="capitalize font-semibold xl:text-[11px] 2xl:text-[13px] 3xl:text-[16px] lg:text-[9px] text-center w-[41%]"
                                  shape="RoundedBorder4"
                                  size="sm"
                                  variant="OutlineBlack9000f"
                                >
        ...
        />
        <Column className="font-poppins items-end lg:mt-[23px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] 2xl:pl-[104px] 3xl:pl-[125px] lg:pl-[74px] xl:pl-[93px] w-[100%]">
          <Column className="justify-start w-[100%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_39.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileAssetsVEmployerPage;
