...
const IMARNFrontendWebsiteSingleProjectPageCheckoutScenerio2FundWalletModalboxPage =
  () => {
...
export default IMARNFrontendWebsiteSingleProjectPageCheckoutScenerio2FundWalletModalboxPage;
