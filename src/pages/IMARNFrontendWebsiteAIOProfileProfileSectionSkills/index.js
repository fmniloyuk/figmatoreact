...
const IMARNFrontendWebsiteAIOProfileProfileSectionSkillsPage = () => {
  ...
  return (
    <>
      <Column className="bg-white_A700 font-poppins items-center justify-start mx-[auto] overflow-auto pt-[2px] w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[8px] w-[99%]">
                <Row className="items-center justify-between w-[99%]">
                  <Column className="items-center w-[23%]">
                    ...
                    <Img
                      src="images/img_emailphonepay_3.svg"
        ...
        <Column className="justify-start lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[85%]">
          <Column className="items-center justify-start ml-[1px] w-[63%]">
            <Row className="items-center justify-evenly w-[100%]">
              ...
              <Button
                className="common-pointer capitalize font-medium lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-bluegray_400 text-center w-[13%]"
          ...
          <Column className="items-center justify-start lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] 3xl:pb-[1094px] lg:pb-[648px] xl:pb-[810px] 2xl:pb-[912px] w-[100%]">
            <Column className="items-center justify-start w-[100%]">
              ...
              <Row className="bg-white_A700 border border-black_900_0c border-solid items-start justify-center lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius15 shadow-bs12 w-[55%]">
                ...
                <Column className="items-center justify-start lg:ml-[20px] xl:ml-[25px] 2xl:ml-[28px] 3xl:ml-[34px] w-[5%]">
                  <Img
                    src="images/img_sort_24X24.svg"
                    className="file_One1"
                    alt="sort"
                  />
                ...
                >
                  <Img
                    ...
                    alt="search"
                  />
                  <Text className="skills" variant="body10">
                    Achievments
                  </Text>
                </Column>
                <Column
                  className="common-pointer items-center justify-start lg:ml-[20px] xl:ml-[25px] 2xl:ml-[28px] 3xl:ml-[34px] lg:mr-[13px] xl:mr-[16px] 2xl:mr-[19px] 3xl:mr-[22px] w-[15%]"
                  onClick={handleNavigate31}
                >
                  <Img
                    src="images/img_megaphone_24X24.svg"
                    className="file_One1"
                    alt="megaphone One"
                  />
                  <Text className="skills" variant="body10">
              ...
              <Row className="items-start justify-between lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
                <Column className="bg-white_A700 border border-black_900_0c border-solid items-center justify-end lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] rounded-radius15 w-[69%]">
                  <Column className="items-center justify-start lg:mt-[14px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[25px] w-[97%]">
                    <Column className="justify-start w-[100%]">
                      ...
                      <List
                        className="gap-[0] min-h-[auto] lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] w-[95%]"
                        orientation="vertical"
                      >
                        <Column className="bg-white_A700 border border-black_900_20 border-solid lg:p-[20px] xl:p-[25px] 2xl:p-[28px] 3xl:p-[34px] rounded-radius15 listgccsalesdirec">
                          <Column className="items-center justify-start pb-[1px] w-[100%]">
                            <Column className="justify-start w-[100%]">
                              <Text
                                className="columnskillsetone"
                                variant="body10"
                              >
                                Skill Set-1
                              </Text>
                            ...
                            <Row className="items-center justify-between xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] pt-[1px] w-[100%]">
                              <Column className="w-[14%]">
                                ...
                                <Stack className="3xl:h-[115px] lg:h-[68px] xl:h-[85px] 2xl:h-[96px] xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] 3xl:w-[114px] lg:w-[67px] xl:w-[84px] 2xl:w-[95px]">
                                  <Text className="SeventySix" variant="body10">
                                    76%
                                  </Text>
                                  <Stack
                                    className="bg-cover bg-repeat Subtract_One"
                                    style={{
                                      backgroundImage:
                              ...
                              <Column className="w-[14%]">
                                ...
                                <Stack className="3xl:h-[115px] lg:h-[68px] xl:h-[85px] 2xl:h-[96px] xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] 3xl:w-[114px] lg:w-[67px] xl:w-[84px] 2xl:w-[95px]">
                                  ...
                                  <div className="bg-blue_700 rounded-radius50 Subtract_One"></div>
                                </Stack>
                              </Column>
                              <Column className="w-[14%]">
                                <Text
                                ...
                                <Stack className="3xl:h-[115px] lg:h-[68px] xl:h-[85px] 2xl:h-[96px] xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] 3xl:w-[114px] lg:w-[67px] xl:w-[84px] 2xl:w-[95px]">
                                  ...
                                  <Column
                                    className="absolute bg-cover bg-repeat 3xl:h-[115px] lg:h-[68px] xl:h-[85px] 2xl:h-[96px] items-end justify-start lg:pl-[33px] xl:pl-[42px] 2xl:pl-[47px] 3xl:pl-[57px] w-[100%]"
                                    style={{
                                      backgroundImage:
                                        "url('images/img_group446.svg')",
                                    }}
                                  >
                                    <div className="bg-blue_700 3xl:h-[115px] lg:h-[68px] xl:h-[85px] 2xl:h-[96px] rounded-bl-[0] rounded-br-[40px] rounded-tl-[0] rounded-tr-[40px] w-[100%]"></div>
                                  </Column>
                                </Stack>
                              </Column>
                              <Column className="w-[14%]">
                                ...
                                <Stack className="3xl:h-[115px] lg:h-[68px] xl:h-[85px] 2xl:h-[96px] xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] 3xl:w-[114px] lg:w-[67px] xl:w-[84px] 2xl:w-[95px]">
                                  ...
                                  >
                                    <Img
                                      src="images/img_signal_100X100.svg"
                                      className="Subtract_One"
                                      alt="signal"
                                    />
                                  </Stack>
                        ...
                        <Column className="bg-white_A700 border border-black_900_20 border-solid lg:p-[20px] xl:p-[25px] 2xl:p-[28px] 3xl:p-[34px] rounded-radius15 listgccsalesdirec">
                          <Column className="items-center justify-end w-[100%]">
                            ...
                            <Row className="items-start justify-between xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] pt-[1px] w-[100%]">
                              <Column className="justify-start pb-[4px] w-[14%]">
                                <Text
                                  className="columntitleofthec"
                                  variant="body10"
                                >
                                ...
                                <Column className="justify-start xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] w-[100%]">
                                  <Stack className="3xl:h-[115px] lg:h-[68px] xl:h-[85px] 2xl:h-[96px] 3xl:w-[114px] lg:w-[67px] xl:w-[84px] 2xl:w-[95px]">
                                    <Text
                                  ...
                                  <Text
                                    className="xl:mt-[119px] 2xl:mt-[134px] 3xl:mt-[161px] lg:mt-[95px] columntitleofthec"
                                    variant="body10"
                                  >
                                    Skill-1
                                  </Text>
                              ...
                              <Column className="justify-start w-[14%]">
                                <Text
                                  className="columntitleofthec"
                                  variant="body10"
                                >
                              ...
                              <Column className="justify-start w-[14%]">
                                ...
                                <Stack className="3xl:h-[115px] lg:h-[68px] xl:h-[85px] 2xl:h-[96px] xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] 3xl:w-[114px] lg:w-[67px] xl:w-[84px] 2xl:w-[95px]">
                                  ...
                                  <Stack
                                    className="bg-cover bg-repeat px-[1px] Subtract_One"
                                    style={{
                                      backgroundImage:
                                        "url('images/img_group446.svg')",
                                    }}
                                  >
                                    <Img
                                      src="images/img_signal_100X100.svg"
                                      className="absolute lg:h-[31px] xl:h-[39px] 2xl:h-[43px] 3xl:h-[52px] right-[0] top-[0] w-[49%]"
                                      alt="signal One"
                                    />
                                  </Stack>
                                </Stack>
                        ...
                        <Column className="bg-white_A700 border border-black_900_20 border-solid lg:p-[20px] xl:p-[25px] 2xl:p-[28px] 3xl:p-[34px] rounded-radius15 listgccsalesdirec">
                          <Column className="items-center justify-start pb-[1px] w-[100%]">
                            ...
                            <Row className="items-end justify-between xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[16px] lg:mt-[9px] pt-[1px] w-[100%]">
                              <Stack className="3xl:h-[115px] lg:h-[68px] xl:h-[85px] 2xl:h-[96px] lg:mt-[17px] xl:mt-[22px] 2xl:mt-[24px] 3xl:mt-[29px] 3xl:w-[114px] lg:w-[67px] xl:w-[84px] 2xl:w-[95px]">
                                <Text className="SeventySix" variant="body10">
                                  76%
                                </Text>
                                <Stack
                    ...
                    <Column className="items-center justify-start lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] rounded-radius6 w-[98%]">
                      <Line className="bg-black_900_14 h-[1px] w-[100%]" />
                      <Button
        ...
        <Column className="items-end lg:mt-[18px] xl:mt-[23px] 2xl:mt-[26px] 3xl:mt-[32px] 2xl:pl-[104px] 3xl:pl-[125px] lg:pl-[74px] xl:pl-[93px] w-[100%]">
          <Column className="justify-start w-[100%]">
            ...
            >
              ...
              <Stack
                className="bg-cover bg-repeat lg:h-[170px] xl:h-[212px] 2xl:h-[239px] 3xl:h-[286px] 3xl:px-[11px] lg:px-[6px] xl:px-[8px] 2xl:px-[9px] rounded-radius15 w-[100%]"
                style={{ backgroundImage: "url('images/img_adv_23.png')" }}
              >
                <Img
...
export default IMARNFrontendWebsiteAIOProfileProfileSectionSkillsPage;
