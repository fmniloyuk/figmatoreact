...
import { Column, Row, Button, Img, Text, Line, Stack, List } from "components";
import Header from "components/Header/Header";
import Footer3 from "components/Footer/Footer3";
import { useNavigate } from "react-router-dom";

const FaisalFreelancingModuleSingleProjectPageDeliveryOnePage = () => {
            ...
            <Row className="items-start w-[85%]">
              <Column className="bg-white_A700 border border-bluegray_102 border-solid justify-start lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius15 w-[66%]">
                <Row className="items-center mt-[1px] w-[77%]">
                  ...
                  <Button
                    className="font-semibold lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-center uppercase w-[18%]"
                    size="lg"
                ...
                <Row className="items-start 3xl:mb-[11px] lg:mb-[6px] xl:mb-[8px] 2xl:mb-[9px] ml-[1px] lg:mt-[20px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] w-[97%]">
                  ...
                  <Column className="items-center justify-start lg:ml-[10px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] w-[92%]">
                    <Row className="items-end justify-between w-[100%]">
                      <Row className="items-start justify-between mb-[1px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] w-[49%]">
                    ...
                    <Column className="justify-start lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[98%]">
                      <Text className="columndescription5" variant="body10">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Amet, sit ullamcorper quam eget mauris sed. Sit sem
                        urna, eget ridiculus orci. Gravida amet, etiam quis sed.
                        Etiam amet mattis metus, fusce tellus aliquam orci.
                        Suscipit adipiscing blandit justo,{" "}
                      </Text>
                      <Row className="items-center lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] w-[58%]">
                        <Column className="bg-gray_100 border border-black_900_20 border-solid items-center 3xl:py-[11px] lg:py-[6px] xl:py-[8px] 2xl:py-[9px] rounded-radius15 w-[42%]">
                          <Img
                            src="images/img_file_2.svg"
                            className="lg:h-[34px] xl:h-[43px] 2xl:h-[48px] 3xl:h-[58px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[9px] lg:w-[33px] xl:w-[42px] 2xl:w-[47px] 3xl:w-[57px]"
                            alt="file"
                          />
                          <Line className="bg-black_900_20 h-[1px] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] w-[100%]" />
                          <Text className="columnfile1" variant="body12">
                            {"<File Name>.Fig"}
                          </Text>
                        </Column>
                        <Button
                          className="2xl:ml-[14px] 3xl:ml-[17px] flex items-center justify-center lg:ml-[10px] text-center w-[29%] xl:ml-[12px]"
                          rightIcon={
                            <Img
                              src="images/img_download_12X12.svg"
                              className="text-center lg:w-[10px] lg:h-[11px] lg:ml-[6px] xl:w-[13px] xl:h-[14px] xl:ml-[8px] 2xl:w-[15px] 2xl:h-[16px] 2xl:ml-[9px] 3xl:w-[18px] 3xl:h-[19px] 3xl:ml-[11px]"
                              alt="download"
                            />
                          }
                        ...
                        <Button
                          className="2xl:ml-[14px] 3xl:ml-[17px] flex items-center justify-center lg:ml-[10px] text-center w-[22%] xl:ml-[12px]"
                          rightIcon={
                            <Img
...
export default FaisalFreelancingModuleSingleProjectPageDeliveryOnePage;
